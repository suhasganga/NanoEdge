...
This request is similar to [`klines`](/docs/binance-spot-api-docs/testnet/websocket-api/market-data-requests#klines), having the same parameters and response.
...
use the [`ticker`](/docs/binance-spot-api-docs/testnet/websocket-api/market-data-requests#rolling-window-price-change-statistics) request.
...
This request is similar to [`ticker.24hr`](/docs/binance-spot-api-docs/testnet/websocket-api/market-data-requests#24hr-ticker-price-change-statistics),
