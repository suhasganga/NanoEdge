...
### Authorize *ad hoc* requests[​](/docs/binance-spot-api-docs/testnet/websocket-api/session-authentication#authorize-ad-hoc-requests "Direct link to authorize-ad-hoc-requests")
