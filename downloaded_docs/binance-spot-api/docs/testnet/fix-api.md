...
successful [ExecutionReport`<8>`](/docs/binance-spot-api-docs/testnet/fix-api#executionreport) and [ListStatus`<N>`](/docs/binance-spot-api-docs/testnet/fix-api#liststatus) messages,
including those in response to orders placed from other FIX sessions and via non-FIX APIs.

Use the `ResponseMode (25036)` field in the initial [Logon`<A>`](/docs/binance-spot-api-docs/testnet/fix-api#logon-request) message
...
The [Logon`<A>`](/docs/binance-spot-api-docs/testnet/fix-api#logon-main) message authenticates your connection to the FIX API.
...
* To understand current limits and usage, please send a [LimitQuery`<XLQ>`](/docs/binance-spot-api-docs/testnet/fix-api#limitquery) message.
  A [LimitResponse`<XLR>`](/docs/binance-spot-api-docs/testnet/fix-api#limitresponse) message will be sent in response, containing information about Order Rate
...
* Upon breaching the limit a [Reject `<3>`](/docs/binance-spot-api-docs/testnet/fix-api#reject) will be sent containing information about the connection limit
...
* To understand how many orders you have placed within a certain time interval, please send a [LimitQuery`<XLQ>`](/docs/binance-spot-api-docs/testnet/fix-api#limitquery) message.
  A [LimitResponse`<XLR>`](/docs/binance-spot-api-docs/testnet/fix-api#limitresponse) message will be sent in response, containing information about Unfilled Order Count and Message Limits.
...
| 35 | MsgType | STRING | Y | Must be the third field in the message.    Possible values:   `0` - [HEARTBEAT](/docs/binance-spot-api-docs/testnet/fix-api#heartbeat)   `1` - [TEST\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#testrequest)   `3` - [REJECT](/docs/binance-spot-api-docs/testnet/fix-api#reject)   `5` - [LOGOUT](/docs/binance-spot-api-docs/testnet/fix-api#logout)   `8` - [EXECUTION\_REPORT](/docs/binance-spot-api-docs/testnet/fix-api#executionreport)    `9` - [ORDER\_CANCEL\_REJECT](/docs/binance-spot-api-docs/testnet/fix-api#ordercancelreject)    `A` - [LOGON](/docs/binance-spot-api-docs/testnet/fix-api#logon-main)    `D` - [NEW\_ORDER\_SINGLE](/docs/binance-spot-api-docs/testnet/fix-api#newordersingle)    `E` - [NEW\_ORDER\_LIST](/docs/binance-spot-api-docs/testnet/fix-api#neworderlist)    `F` - [ORDER\_CANCEL\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#ordercancelrequest)    `N` - [LIST\_STATUS](/docs/binance-spot-api-docs/testnet/fix-api#liststatus)    `q` - [ORDER\_MASS\_CANCEL\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#ordermasscancelrequest)    `r` - [ORDER\_MASS\_CANCEL\_REPORT](/docs/binance-spot-api-docs/testnet/fix-api#ordermasscancelreport)    `XCN` - [ORDER\_CANCEL\_REQUEST\_AND\_NEW\_ORDER\_SINGLE](/docs/binance-spot-api-docs/testnet/fix-api#ordercancelrequestandnewordersingle)    `XLQ` - [LIMIT\_QUERY](/docs/binance-spot-api-docs/testnet/fix-api#limitquery)    `XLR` - [LIMIT\_RESPONSE](/docs/binance-spot-api-docs/testnet/fix-api#limitresponse)    `B` - [NEWS](/docs/binance-spot-api-docs/testnet/fix-api#news)    `x`- [INSTRUMENT\_LIST\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#instrumentlistrequest)    `y` - [INSTRUMENT\_LIST](/docs/binance-spot-api-docs/testnet/fix-api#instrumentlist)   `V` - [MARKET\_DATA\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#marketdatarequest)    `Y` - [MARKET\_DATA\_REQUEST\_REJECT](/docs/binance-spot-api-docs/testnet/fix-api#marketdatarequestreject)   `W` - [MARKET\_DATA\_SNAPSHOT](/docs/binance-spot-api-docs/testnet/fix-api#marketdatasnapshot)   `X` - [MARKET\_DATA\_INCREMENTAL\_REFRESH](/docs/binance-spot-api-docs/testnet/fix-api#marketdataincrementalrefresh)    `XAK` - [ORDER\_AMEND\_KEEP\_PRIORITY\_REQUEST](/docs/binance-spot-api-docs/testnet/fix-api#orderamendkeeppriorityrequest)    `XAR` - [ORDER\_AMEND\_REJECT](/docs/binance-spot-api-docs/testnet/fix-api#orderamendreject) |
...
| 25000 | RecvWindow | FLOAT | N | Number of milliseconds after `SendingTime (52)` the request is valid for.    Defaults to `5000` milliseconds in [Logon`<A>`](/docs/binance-spot-api-docs/testnet/fix-api#logon-request) and has a max value of `60000` milliseconds.   Supports up to three decimal places of precision (e.g., 6000.346) so that microseconds may be specified. |
...
Please refer to [Connection Limits](/docs/binance-spot-api-docs/testnet/fix-api#connection-limits).
...
| 25035 | MessageHandling | INT | Y | Possible values:    `1` - UNORDERED    `2` - SEQUENTIAL    Please refer to [On message order processing](/docs/binance-spot-api-docs/testnet/fix-api#orderedmode) for more information. |
...
> Please refer to [Supported Order Types](/docs/binance-spot-api-docs/testnet/fix-api#NewOrderSingle-required-fields).

| Tag | Name | Type | Required | Description |
| --- | --- | --- | --- | --- |
| 11 | ClOrdID | STRING | Y | `ClOrdID` to be assigned to the order. |
| 38 | OrderQty | QTY | N | Quantity of the order |
| 40 | OrdType | CHAR | Y | See the [table](/docs/binance-spot-api-docs/testnet/fix-api#ordertype) to understand supported order types and the required fields to use them.  Possible values:    `1` - MARKET    `2` - LIMIT    `3` - STOP    `4` - STOP\_LIMIT    `P`- PEGGED |
| 18 | ExecInst | CHAR | N | Possible values:    `6` - PARTICIPATE\_DONT\_INITIATE |
...
| 59 | TimeInForce | CHAR | N | Possible values:    `1` - GOOD\_TILL\_CANCEL    `3` - IMMEDIATE\_OR\_CANCEL    `4` - FILL\_OR\_KILL |
...
| 25001 | SelfTradePreventionMode | CHAR | N | Possible values:    `1` - NONE    `2` - EXPIRE\_TAKER    `3` - EXPIRE\_MAKER    `4` - EXPIRE\_BOTH    `5` - DECREMENT   `6` - TRANSFER |
| 211 | PegOffsetValue | FLOAT | N | Amount added to the peg in the context of the PegOffsetType |
| 1094 | PegPriceType | CHAR | N | Defines the type of peg   Possible values:   `4` - MARKET\_PEG   `5` - PRIMARY\_PEG |
| 835 | PegMoveType | CHAR | N | Describes whether peg is fixed or floats. Required for Pegged Orders and must be set to `1` (FIXED) |
| 836 | PegOffsetType | CHAR | N | Type of price peg offset.   Possible values:    `3` - PRICE\_TIER |
...
| 1107 | TriggerPriceType | CHAR | N | Possible values:    `2` - LAST\_TRADE |
| 1109 | TriggerPriceDirection | CHAR | N | Used to differentiate between StopLoss and TakeProfit orders. See [table](/docs/binance-spot-api-docs/testnet/fix-api#ordertype).  Possible values:    `U` - TRIGGER\_IF\_THE\_PRICE\_OF\_THE\_SPECIFIED\_TYPE\_GOES\_UP\_TO\_OR\_THROUGH\_THE\_SPECIFIED\_TRIGGER\_PRICE    `D` - TRIGGER\_IF\_THE\_PRICE\_OF\_THE\_SPECIFIED\_TYPE\_GOES\_DOWN\_TO\_OR\_THROUGH\_THE\_SPECIFIED\_TRIGGER\_PRICE |
...
| 38 | OrderQty | QTY | N | Quantity of the order. |
| 40 | OrdType | CHAR | Y | Possible values:    `1` - MARKET    `2` - LIMIT    `3` - STOP\_LOSS    `4` - STOP\_LIMIT    `P` - PEGGED |
...
| 39 | OrdStatus | CHAR | Y | Possible values:    `0` - NEW    `1` - PARTIALLY\_FILLED    `2` - FILLED    `4` - CANCELED `6` - PENDING\_CANCEL   `8` - REJECTED    `A` - PENDING\_NEW    `C` - EXPIRED    Note that FIX does not support `EXPIRED_IN_MATCH` status, and get converted to `EXPIRED` in FIX. |
| 70 | AllocID | INT | N | Allocation ID as assigned by the exchange. |
| 574 | MatchType | INT | N | Possible values:  `1` - ONE\_PARTY\_TRADE\_REPORT  `4` - AUTO\_MATCH |
...
| 25002 | CancelRestrictions | INT | N | Restrictions on the cancel. Possible values:    `1` - ONLY\_NEW    `2` - ONLY\_PARTIALLY\_FILLED |
...
| 434 | CxlRejResponseTo | CHAR | Y | Type of request that this OrderCancelReject`<9>` is in response to.    Possible values:    `1` - ORDER\_CANCEL\_REQUEST |
...
| Tag | Name | Type | Required | Description |
| --- | --- | --- | --- | --- |
| 25033 | OrderCancelRequestAndNewOrderSingleMode | INT | Y | What action should be taken if cancel fails.    Possible values:    `1` - STOP\_ON\_FAILURE    `2` - ALLOW\_FAILURE |
| 25038 | OrderRateLimitExceededMode | INT | N | What should be done to the cancellation request if you exceed the unfilled order rate limit.   Possible values: `1` - DO\_NOTHING    `2` - CANCEL\_ONLY |
...
| 530 | MassCancelRequestType | CHAR | Y | Possible values:    `1` - CANCEL\_SYMBOL\_ORDERS |
...
| 531 | MassCancelResponse | CHAR | Y | Possible values:    `0` - CANCEL\_REQUEST\_REJECTED    `1` - CANCEL\_SYMBOL\_ORDERS |
...
Please refer to [Supported Order List Types](/docs/binance-spot-api-docs/testnet/fix-api#order-list-types) for supported order types and triggering instructions.

| Tag | Name | Type | Required | Description |
| --- | --- | --- | --- | --- |
| 25014 | ClListID | STRING | Y | `ClListID` to be assigned to the order list. |
| 1385 | ContingencyType | INT | N | Possible values:    `1` - ONE\_CANCELS\_THE\_OTHER    `2` - ONE\_TRIGGERS\_THE\_OTHER |
...
| ==>25011 | ListTriggerType | CHAR | N | What needs to happen to the order pointed to by ListTriggerTriggerIndex in order for the action to take place.    Possible values:    `1` - ACTIVATED    `2` - PARTIALLY\_FILLED    `3` - FILLED |
...
| OPO | `2` | 1. working order     2. pending order | 1. working order=`BUY`     2. pending order=`SELL` | 1. working order=`LIMIT` or `LIMIT_MAKER`      2. pending order=ANY | 1. working order:  NONE     2. pending order:   `25010=1|25011=3|25012=0|25013=1|` |
| OPOCO | `2` | 1. working order     2. pending below order     3. pending above order | 1. working order=`BUY`     2. pending below order=`SELL`     3. pending above order=`SELL` | 1. working order=`LIMIT` or `LIMIT_MAKER`      2. pending below order=`STOP_LOSS` or `STOP_LOSS_LIMIT`     3. pending above order=`LIMIT_MAKER` | 1. working order:  NONE     2. pending below order:  `25010=2|25011=3|25012=0|25013=2|25011=2|25012=2|25013=2|`    3. pending above order:  `25010=2|25011=3|25012=0|25013=2|25011=1|25012=1|25013=2|` |
| OPOCO | `2` | 1. working order     2. pending below order     3. pending above order | 1. working order=`BUY`   2. pending below order=`SELL`     3. pending above order=`SELL` | 1. working order=`LIMIT` or `LIMIT_MAKER`      2. pending below order=`STOP_LOSS` or `STOP_LOSS_LIMIT`     3. pending above order=`TAKE_PROFIT` or `TAKE_PROFIT_LIMIT` | 1. working order:  NONE     2. pending below order:  `25010=2|25011=3|25012=0|25013=2|25011=1|25012=2|25013=2|`    3. pending above order:  `25010=2|25011=3|25012=0|25013=2|25011=1|25012=1|25013=2|` |
...
> Please see [Response Mode](/docs/binance-spot-api-docs/testnet/fix-api#responsemode) for other behavior options.
...
| 1385 | ContingencyType | INT | N | Possible values:    `1` - ONE\_CANCELS\_THE\_OTHER    `2` - ONE\_TRIGGERS\_THE\_OTHER |
| 429 | ListStatusType | INT | Y | Possible values:    `2` - RESPONSE   `4` - EXEC\_STARTED    `5` - ALL\_DONE    `100` - UPDATED |
| 431 | ListOrderStatus | INT | Y | Possible values:    `3` - EXECUTING    `6` - ALL\_DONE    `7` - REJECT |
...
| =>25010 | NoListTriggeringInstructions | NUMINGROUP | N | The length of the array for ListTriggeringInstructions. |
| ==>25011 | ListTriggerType | CHAR | N | Possible values:    `1` - ACTIVATED    `2` - PARTIALLY\_FILLED    `3` - FILLED |
...
| =>25004 | LimitType | CHAR | Y | Possible values:    `1` - ORDER\_LIMIT    `2` - MESSAGE\_LIMIT |
...
| 559 | InstrumentListRequestType | INT | Y | Possible values:    `0` - SINGLE\_INSTRUMENT    `4` - ALL\_INSTRUMENTS |
...
> [!NOTE]
> More detailed symbol information is available through the [exchangeInfo](https://github.com/binance/binance-spot-api-docs/blob/master/testnet/rest-api/general-endpoints.md#exchange-information) endpoint.
...
| =>562 | MinTradeVol | QTY | N | Corresponds to the [LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#lot_size) filter |
| =>1140 | MaxTradeVol | QTY | N | Corresponds to the [LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#lot_size) filter |
| =>25039 | MinQtyIncrement | QTY | N | Corresponds to the [LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#lot_size) filter |
| =>25040 | MarketMinTradeVol | QTY | N | Corresponds to the [MARKET\_LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#market_lot_size) filter |
| =>25041 | MarketMaxTradeVol | QTY | N | Corresponds to the [MARKET\_LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#market_lot_size) filter |
| =>25042 | MarketMinQtyIncrement | QTY | N | Corresponds to the [MARKET\_LOT\_SIZE](/docs/binance-spot-api-docs/testnet/filters#market_lot_size) filter |
...
> [!NOTE]
> In the [Individual Symbol Book Ticker Stream](/docs/binance-spot-api-docs/testnet/fix-api#symbolbooktickerstream), when `MDUpdateAction` is set to `CHANGE(1)` in a
> [MarketDataIncrementalRefresh`<X>`](/docs/binance-spot-api-docs/testnet/fix-api#marketdataincrementalrefresh) message sent from the server, it replaces the previous best quote.
...
> [!NOTE]
> Since the [MarketDataSnapshot`<W>`](/docs/binance-spot-api-docs/testnet/fix-api#marketdatasnapshot) have a limit on the number of price levels (5000 on each side maximum), you won't learn the quantities for the levels outside of the initial snapshot unless they change.
...
| 281 | MDReqRejReason | CHAR | N | Possible values:    `1` - DUPLICATE\_MDREQID    `2` - TOO\_MANY\_SUBSCRIPTIONS |
...
| =>25043 | FirstBookUpdateID | INT | N | Only present in [Diff. Depth Stream](/docs/binance-spot-api-docs/testnet/fix-api#diffdepthstream).    Market Data Entry will default to the same `FirstBookUpdateID` of the previous Market Data Entry in the same Market Data message if `FirstBookUpdateID` is not specified |
| =>25044 | LastBookUpdateID | INT | N | Only present in [Diff. Depth Stream](/docs/binance-spot-api-docs/testnet/fix-api#diffdepthstream) and [Individual Symbol Book Ticker Stream](/docs/binance-spot-api-docs/testnet/fix-api#symbolbooktickerstream).    Market Data Entry will default to the same `LastBookUpdateID` of the previous Market Data Entry in the same Market Data message if `LastBookUpdateID` is not specified |
