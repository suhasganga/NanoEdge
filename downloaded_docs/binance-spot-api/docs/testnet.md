### How can I use the Spot Test Network? [​](/docs/binance-spot-api-docs/testnet#faq-how-to-use "Direct link to How can I use the Spot Test Network? ")
...
### Can I use the `/sapi` endpoints on the Spot Test Network? [​](/docs/binance-spot-api-docs/testnet#faq-supported-endpoints "Direct link to faq-supported-endpoints")
...
### How to get funds in/out of the Spot Test Network? [​](/docs/binance-spot-api-docs/testnet#faq-funds-transfer "Direct link to How to get funds in/out of the Spot Test Network? ")
...
### What are the restrictions on the Spot Test Network? [​](/docs/binance-spot-api-docs/testnet#faq-restrictions "Direct link to What are the restrictions on the Spot Test Network? ")
...
### All my data has disappeared! What happened? [​](/docs/binance-spot-api-docs/testnet#faq-periodic-reset "Direct link to All my data has disappeared! What happened? ")
...
### What is the difference between `klines` and `uiKlines`? [​](/docs/binance-spot-api-docs/testnet#ui-klines "Direct link to ui-klines")

On the Spot Test Network, these 2 requests always return the same data.

---

### What are RSA API Keys? [​](/docs/binance-spot-api-docs/testnet#faq-rsa-keys "Direct link to What are RSA API Keys? ")
...
### What type of RSA keys are supported? [​](/docs/binance-spot-api-docs/testnet#faq-rsa-types "Direct link to What type of RSA keys are supported? ")
...
### How can I use RSA API Keys? [​](/docs/binance-spot-api-docs/testnet#faq-rsa-how-to "Direct link to How can I use RSA API Keys? ")
...
### What are Ed25519 API keys? [​](/docs/binance-spot-api-docs/testnet#faq-ed25519-keys "Direct link to What are Ed25519 API keys? ")

Ed25519 API keys are an alternative to [RSA API keys](/docs/binance-spot-api-docs/testnet#faq-rsa-keys),
...
### Why use Ed25519 instead of RSA API keys? [​](/docs/binance-spot-api-docs/testnet#faq-ed25519-vs-rsa "Direct link to Why use Ed25519 instead of RSA API keys? ")
...
### How can I use Ed25519 API keys? [​](/docs/binance-spot-api-docs/testnet#faq-ed25519-how-to "Direct link to How can I use Ed25519 API keys? ")
