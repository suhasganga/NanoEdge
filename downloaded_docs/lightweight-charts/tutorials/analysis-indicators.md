...
### Available indicators[​](#available-indicators "Direct link to Available indicators")
...
## How to use the examples[​](#how-to-use-the-examples "Direct link to How to use the examples")
...
### Option 1: copy the source code[​](#option-1-copy-the-source-code "Direct link to Option 1: copy the source code")
...
### Option 2: compile the examples[​](#option-2-compile-the-examples "Direct link to Option 2: compile the examples")
...
## How to add indicator[​](#how-to-add-indicator "Direct link to How to add indicator")
...
### Helper function (recommended)[​](#helper-function-recommended "Direct link to Helper function (recommended)")
...
### Direct calculation[​](#direct-calculation "Direct link to Direct calculation")
