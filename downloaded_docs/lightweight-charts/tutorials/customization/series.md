...
The available options for the candlestick series is a combination of the following interfaces: [CandlestickStyleOptions](/lightweight-charts/docs/api/interfaces/CandlestickStyleOptions) and [SeriesOptionsCommon](/lightweight-charts/docs/api/interfaces/SeriesOptionsCommon).

## Setting custom colors for the candlestick series[​](#setting-custom-colors-for-the-candlestick-series "Direct link to Setting custom colors for the candlestick series")
...
[View in a new window](/lightweight-charts/252eccb3441ffe3f12a6550113b197d2.html)
...
You can download the HTML file for example at this stage [here](/lightweight-charts/252eccb3441ffe3f12a6550113b197d2.html) in case you've encountered a problem or would like to start the next step from this point.
