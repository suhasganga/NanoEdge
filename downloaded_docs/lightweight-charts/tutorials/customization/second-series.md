...
In this section, we will be adding an [area series](/lightweight-charts/docs/series-types#area) to the chart with a subtle vertical gradient. It's purpose is solely for aesthetic reasons (only to make the chart more visually appealing). However, it will teach us a few key points about the differences between different series types and the visual stacking order.

## Preparing the data for the area series[​](#preparing-the-data-for-the-area-series "Direct link to Preparing the data for the area series")
...
## Adding the area series and setting it's options[​](#adding-the-area-series-and-setting-its-options "Direct link to Adding the area series and setting it's options")
...
## Visual stacking order of series[​](#visual-stacking-order-of-series "Direct link to Visual stacking order of series")
...
[View in a new window](/lightweight-charts/4ce3dd9dcf7c5ea67e4c322bbbe543e5.html)
...
You can download the HTML file for example at this stage [here](/lightweight-charts/4ce3dd9dcf7c5ea67e4c322bbbe543e5.html) in case you've encountered a problem or would like to start the next step from this point.
