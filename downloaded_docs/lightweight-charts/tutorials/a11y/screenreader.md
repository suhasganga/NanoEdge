...
## Use of ARIA attributes in the chart[​](#use-of-aria-attributes-in-the-chart "Direct link to Use of ARIA attributes in the chart")

### aria-live[​](#aria-live "Direct link to aria-live")
...
### Adding the ARIA attributes to an existing chart via JavaScript[​](#adding-the-aria-attributes-to-an-existing-chart-via-javascript "Direct link to Adding the ARIA attributes to an existing chart via JavaScript")
...
## Generating a description of the chart[​](#generating-a-description-of-the-chart "Direct link to Generating a description of the chart")
...
## Semantic HTML[​](#semantic-html "Direct link to Semantic HTML")
