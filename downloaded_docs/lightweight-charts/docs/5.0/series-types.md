...
* **Series Definition**: [`AreaSeries`](/lightweight-charts/docs/5.0/api/variables/AreaSeries)
* **Data format**: [`SingleValueData`](/lightweight-charts/docs/5.0/api/interfaces/SingleValueData) or [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsCommon) and [`AreaStyleOptions`](/lightweight-charts/docs/5.0/api/interfaces/AreaStyleOptions)

This series is represented with a colored area between the [time scale](/lightweight-charts/docs/5.0/time-scale) and line connecting all data points:
...
* **Series Definition**: [`BarSeries`](/lightweight-charts/docs/5.0/api/variables/BarSeries)
* **Data format**: [`BarData`](/lightweight-charts/docs/5.0/api/interfaces/BarData) or [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsCommon) and [`BarStyleOptions`](/lightweight-charts/docs/5.0/api/interfaces/BarStyleOptions)
...
* **Series Definition**: [`BaselineSeries`](/lightweight-charts/docs/5.0/api/variables/BaselineSeries)
* **Data format**: [`SingleValueData`](/lightweight-charts/docs/5.0/api/interfaces/SingleValueData) or [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsCommon) and [`BaselineStyleOptions`](/lightweight-charts/docs/5.0/api/interfaces/BaselineStyleOptions)

This series is represented with two colored areas between the [the base value line](/lightweight-charts/docs/5.0/api/interfaces/BaselineStyleOptions#basevalue) and line connecting all data points:
...
* **Series Definition**: [`CandlestickSeries`](/lightweight-charts/docs/5.0/api/variables/CandlestickSeries)
* **Data format**: [`CandlestickData`](/lightweight-charts/docs/5.0/api/interfaces/CandlestickData) or [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsCommon) and [`CandlestickStyleOptions`](/lightweight-charts/docs/5.0/api/interfaces/CandlestickStyleOptions)
...
* **Series Definition**: [`HistogramSeries`](/lightweight-charts/docs/5.0/api/variables/HistogramSeries)
* **Data format**: [`HistogramData`](/lightweight-charts/docs/5.0/api/interfaces/HistogramData) or [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsCommon) and [`HistogramStyleOptions`](/lightweight-charts/docs/5.0/api/interfaces/HistogramStyleOptions)
...
* **Series Definition**: [`LineSeries`](/lightweight-charts/docs/5.0/api/variables/LineSeries)
* **Data format**: [`LineData`](/lightweight-charts/docs/5.0/api/interfaces/LineData) or [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsCommon) and [`LineStyleOptions`](/lightweight-charts/docs/5.0/api/interfaces/LineStyleOptions)
...
To define a custom series type, create a class that implements the [`ICustomSeriesPaneView`](/lightweight-charts/docs/5.0/api/interfaces/ICustomSeriesPaneView) interface. This class defines the rendering code that Lightweight Charts™ uses to draw the series on the chart.
Once your custom series type is defined, it can be added to any chart instance using the [`addCustomSeries()`](/lightweight-charts/docs/5.0/api/interfaces/IChartApi#addcustomseries) method. Custom series types function like any other series.

For more information, refer to the [Plugins](/lightweight-charts/docs/5.0/plugins/intro) article.

## Customization[​](#customization "Direct link to Customization")

Each series type offers a unique set of customization options listed on the [`SeriesStyleOptionsMap`](/lightweight-charts/docs/5.0/api/interfaces/SeriesStyleOptionsMap) page.
...
* Specify the default options using the corresponding parameter while creating a series:
  ...
  ```
* Use the [`ISeriesApi.applyOptions`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi#applyoptions) method to apply other options on the fly:
