...
### Using pure JavaScript[​](#using-pure-javascript "Direct link to Using pure JavaScript")
...
### Using the date-fns-tz library[​](#using-the-date-fns-tz-library "Direct link to Using the date-fns-tz library")
...
### Using the IANA time zone database[​](#using-the-iana-time-zone-database "Direct link to Using the IANA time zone database")
...
## Why are time zones not supported?[​](#why-are-time-zones-not-supported "Direct link to Why are time zones not supported?")
