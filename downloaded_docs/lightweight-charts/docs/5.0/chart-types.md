...
* **Creation method**: [`createChart`](/lightweight-charts/docs/5.0/api/functions/createChart)
...
* **Creation method**: [`createYieldCurveChart`](/lightweight-charts/docs/5.0/api/functions/createYieldCurveChart)
...
* **Creation method**: [`createOptionsChart`](/lightweight-charts/docs/5.0/api/functions/createOptionsChart)
...
* **Creation method**: [`createChartEx`](/lightweight-charts/docs/5.0/api/functions/createChartEx)
