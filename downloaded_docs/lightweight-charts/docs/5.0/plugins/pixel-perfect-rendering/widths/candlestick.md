...
It is recommend that you first read the [Pixel Perfect Rendering](/lightweight-charts/docs/5.0/plugins/pixel-perfect-rendering) page.
...
It is expected that candles can overlap slightly at smaller bar spacings (more pronounced on lower resolution devices). This produces a more readable chart. If you need to ensure that bars can never overlap then rather use the widths for [Columns](/lightweight-charts/docs/5.0/plugins/pixel-perfect-rendering/widths/columns) or the [full bar width](/lightweight-charts/docs/5.0/plugins/pixel-perfect-rendering/widths/full-bar-width) calculation.
