...
> **PriceToCoordinateConverter**: (`price`) => [`Coordinate`](/lightweight-charts/docs/5.0/api/type-aliases/Coordinate) | `null`
...
[`Coordinate`](/lightweight-charts/docs/5.0/api/type-aliases/Coordinate) | `null`