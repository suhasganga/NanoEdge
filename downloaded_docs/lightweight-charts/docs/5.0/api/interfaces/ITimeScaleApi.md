...
> **getVisibleRange**(): [`IRange`](/lightweight-charts/docs/5.0/api/interfaces/IRange)<`HorzScaleItem`>
...
To get complete information about current visible range, please use [getVisibleLogicalRange](/lightweight-charts/docs/5.0/api/interfaces/ITimeScaleApi#getvisiblelogicalrange) and [ISeriesApi.barsInLogicalRange](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi#barsinlogicalrange).

#### Returns[​](#returns-3 "Direct link to Returns")

[`IRange`](/lightweight-charts/docs/5.0/api/interfaces/IRange)<`HorzScaleItem`>
...
But if you can approximate indexes on your own - you could use [setVisibleLogicalRange](/lightweight-charts/docs/5.0/api/interfaces/ITimeScaleApi#setvisiblelogicalrange) instead.

#### Parameters[​](#parameters-1 "Direct link to Parameters")

• **range**: [`IRange`](/lightweight-charts/docs/5.0/api/interfaces/IRange)<`HorzScaleItem`>
...
> **getVisibleLogicalRange**(): [`LogicalRange`](/lightweight-charts/docs/5.0/api/type-aliases/LogicalRange)

Returns the current visible [logical range](/lightweight-charts/docs/5.0/time-scale#logical-range) of the chart as an object with the first and last time points of the logical range, or returns `null` if the chart has no data.
...
Sets visible [logical range](/lightweight-charts/docs/5.0/time-scale#logical-range) of data.

#### Parameters[​](#parameters-2 "Direct link to Parameters")

• **range**: [`IRange`](/lightweight-charts/docs/5.0/api/interfaces/IRange)<`number`>
...
> **logicalToCoordinate**(`logical`): [`Coordinate`](/lightweight-charts/docs/5.0/api/type-aliases/Coordinate)

Converts a logical index to local x coordinate.

#### Parameters[​](#parameters-3 "Direct link to Parameters")

• **logical**: [`Logical`](/lightweight-charts/docs/5.0/api/type-aliases/Logical)
...
> **coordinateToLogical**(`x`): [`Logical`](/lightweight-charts/docs/5.0/api/type-aliases/Logical)
...
> **timeToIndex**(`time`, `findNearest`?): [`TimePointIndex`](/lightweight-charts/docs/5.0/api/type-aliases/TimePointIndex)
...
> **timeToCoordinate**(`time`): [`Coordinate`](/lightweight-charts/docs/5.0/api/type-aliases/Coordinate)
...
The argument passed to the handler function is an object with `from` and `to` properties of type [Time](/lightweight-charts/docs/5.0/api/type-aliases/Time), or `null` if there is no visible data.

#### Parameters[​](#parameters-8 "Direct link to Parameters")

• **handler**: [`TimeRangeChangeEventHandler`](/lightweight-charts/docs/5.0/api/type-aliases/TimeRangeChangeEventHandler)<`HorzScaleItem`>
...
Unsubscribe a handler that was previously subscribed using [subscribeVisibleTimeRangeChange](/lightweight-charts/docs/5.0/api/interfaces/ITimeScaleApi#subscribevisibletimerangechange).
...
• **handler**: [`LogicalRangeChangeEventHandler`](/lightweight-charts/docs/5.0/api/type-aliases/LogicalRangeChangeEventHandler)
...
Unsubscribe a handler that was previously subscribed using [subscribeVisibleLogicalRangeChange](/lightweight-charts/docs/5.0/api/interfaces/ITimeScaleApi#subscribevisiblelogicalrangechange).
...
• **handler**: [`SizeChangeEventHandler`](/lightweight-charts/docs/5.0/api/type-aliases/SizeChangeEventHandler)
...
• **options**: [`DeepPartial`](/lightweight-charts/docs/5.0/api/type-aliases/DeepPartial) <[`HorzScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/HorzScaleOptions)>
...
> **options**(): `Readonly` <[`HorzScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/HorzScaleOptions)>

Returns current options

#### Returns[​](#returns-23 "Direct link to Returns")

`Readonly` <[`HorzScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/HorzScaleOptions)>
