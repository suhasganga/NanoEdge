...
• **options**: [`DeepPartial`](/lightweight-charts/docs/5.0/api/type-aliases/DeepPartial) <[`PriceScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/PriceScaleOptions)>
...
> **options**(): `Readonly` <[`PriceScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/PriceScaleOptions)>

Returns currently applied options of the price scale

#### Returns[​](#returns-1 "Direct link to Returns")

`Readonly` <[`PriceScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/PriceScaleOptions)>
...
> **getVisibleRange**(): [`IRange`](/lightweight-charts/docs/5.0/api/interfaces/IRange)<`number`>

Returns the visible range of the price scale.

#### Returns[​](#returns-4 "Direct link to Returns")

[`IRange`](/lightweight-charts/docs/5.0/api/interfaces/IRange)<`number`>
