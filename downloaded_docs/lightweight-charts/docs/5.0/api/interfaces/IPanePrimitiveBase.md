...
> `optional` **paneViews**(): readonly [`IPanePrimitivePaneView`](/lightweight-charts/docs/5.0/api/interfaces/IPanePrimitivePaneView)[]

Returns array of objects representing primitive in the main area of the chart

#### Returns[​](#returns-1 "Direct link to Returns")

readonly [`IPanePrimitivePaneView`](/lightweight-charts/docs/5.0/api/interfaces/IPanePrimitivePaneView)[]
