...
> **index**: [`TimePointIndex`](/lightweight-charts/docs/5.0/api/type-aliases/TimePointIndex)
...
> **weight**: [`TickMarkWeightValue`](/lightweight-charts/docs/5.0/api/type-aliases/TickMarkWeightValue)
