...
> **horzAlign**: [`HorzAlign`](/lightweight-charts/docs/5.0/api/type-aliases/HorzAlign)
...
> **vertAlign**: [`VertAlign`](/lightweight-charts/docs/5.0/api/type-aliases/VertAlign)
...
> **lines**: [`TextWatermarkLineOptions`](/lightweight-charts/docs/5.0/api/interfaces/TextWatermarkLineOptions)[]
