...
* [`ChartOptionsImpl`](/lightweight-charts/docs/5.0/api/interfaces/ChartOptionsImpl) <[`Time`](/lightweight-charts/docs/5.0/api/type-aliases/Time)>
...
> **localization**: [`LocalizationOptions`](/lightweight-charts/docs/5.0/api/interfaces/LocalizationOptions) <[`Time`](/lightweight-charts/docs/5.0/api/type-aliases/Time)>
...
> **timeScale**: [`TimeScaleOptions`](/lightweight-charts/docs/5.0/api/interfaces/TimeScaleOptions)
