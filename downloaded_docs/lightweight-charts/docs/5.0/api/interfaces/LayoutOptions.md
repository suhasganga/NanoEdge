...
> **background**: [`Background`](/lightweight-charts/docs/5.0/api/type-aliases/Background)
...
> **panes**: [`LayoutPanesOptions`](/lightweight-charts/docs/5.0/api/interfaces/LayoutPanesOptions)
...
> **colorSpace**: [`ColorSpace`](/lightweight-charts/docs/5.0/api/type-aliases/ColorSpace)
...
> **colorParsers**: [`CustomColorParser`](/lightweight-charts/docs/5.0/api/type-aliases/CustomColorParser)[]
...
* An [Rgba](/lightweight-charts/docs/5.0/api/type-aliases/Rgba) array [r,g,b,a] for valid colors (with values 0-255 for rgb and 0-1 for a)
