...
> **mode**: [`PriceScaleMode`](/lightweight-charts/docs/5.0/api/enumerations/PriceScaleMode)
...
> **scaleMargins**: [`PriceScaleMargins`](/lightweight-charts/docs/5.0/api/interfaces/PriceScaleMargins)
...
If not provided [LayoutOptions.textColor](/lightweight-charts/docs/5.0/api/interfaces/LayoutOptions#textcolor) is used.
