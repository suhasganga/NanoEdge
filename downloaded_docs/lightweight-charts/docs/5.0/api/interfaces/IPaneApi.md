...
• **primitive**: [`IPanePrimitive`](/lightweight-charts/docs/5.0/api/type-aliases/IPanePrimitive)<`HorzScaleItem`>
...
> **priceScale**(`priceScaleId`): [`IPriceScaleApi`](/lightweight-charts/docs/5.0/api/interfaces/IPriceScaleApi)
...
> **addCustomSeries**<`TData`, `TOptions`, `TPartialOptions`>(`customPaneView`, `customOptions`?): [`ISeriesApi`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi)<`"Custom"`, `HorzScaleItem`, [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)<`HorzScaleItem`> | `TData`, `TOptions`, `TPartialOptions`>
...
[`ISeriesApi`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi)<`"Custom"`, `HorzScaleItem`, [`WhitespaceData`](/lightweight-charts/docs/5.0/api/interfaces/WhitespaceData)<`HorzScaleItem`> | `TData`, `TOptions`, `TPartialOptions`>

---

### addSeries()[​](#addseries "Direct link to addSeries()")

> **addSeries**<`T`>(`definition`, `options`?): [`ISeriesApi`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi)<`T`, `HorzScaleItem`, [`SeriesDataItemTypeMap`](/lightweight-charts/docs/5.0/api/interfaces/SeriesDataItemTypeMap)<`HorzScaleItem`>[`T`], [`SeriesOptionsMap`](/lightweight-charts/docs/5.0/api/interfaces/SeriesOptionsMap)[`T`], [`SeriesPartialOptionsMap`](/lightweight-charts/docs/5.0/api/interfaces/SeriesPartialOptionsMap)[`T`]>
