...
## 5.1.0[​](#510 "Direct link to 5.1.0")
...
### Major Updates in 5.1[​](#major-updates-in-51 "Direct link to Major Updates in 5.1")

#### Data Conflation[​](#data-conflation "Direct link to Data Conflation")
...
## 5.0.9[​](#509 "Direct link to 5.0.9")
...
* Added *Dual Range Histogram Series* custom plugin example that visualizes paired positive and negative value ranges for each time point using a column-based display. (PR [#1934](https://github.com/tradingview/lightweight-charts/pull/1934))
* Added *Pretty Histogram* plugin example demonstrating non-standard histogram rendering. (PR [#1930](https://github.com/tradingview/lightweight-charts/pull/1930))
...
## 5.0.8[​](#508 "Direct link to 5.0.8")
...
## 5.0.7[​](#507 "Direct link to 5.0.7")
...
## 5.0.6[​](#506 "Direct link to 5.0.6")
...
## 5.0.5[​](#505 "Direct link to 5.0.5")
...
## 5.0.4[​](#504 "Direct link to 5.0.4")
...
## 5.0.3[​](#503 "Direct link to 5.0.3")
...
## 5.0.2[​](#502 "Direct link to 5.0.2")
...
## 5.0.0[​](#500 "Direct link to 5.0.0")
...
### Major Updates in 5.0[​](#major-updates-in-50 "Direct link to Major Updates in 5.0")

#### Multi-Pane Support[​](#multi-pane-support "Direct link to Multi-Pane Support")
...
See [Panes](/lightweight-charts/docs/panes) for more information.

#### New Chart Types[​](#new-chart-types "Direct link to New Chart Types")
...
See [Chart types](/lightweight-charts/docs/chart-types) for more information about the [Yield Curve Chart](/lightweight-charts/docs/chart-types#yield-curve-chart) and [Options Chart](/lightweight-charts/docs/chart-types#options-chart-price-based) types.

#### Enhanced Color Support[​](#enhanced-color-support "Direct link to Enhanced Color Support")
...
#### Architectural Improvements[​](#architectural-improvements "Direct link to Architectural Improvements")
...
* New unified series creation API (see [migration guide](/lightweight-charts/docs/migrations/from-v4-to-v5))
...
See the full migration guide: [Migrating from v4 to v5](/lightweight-charts/docs/migrations/from-v4-to-v5)
...
## 4.2.3[​](#423 "Direct link to 4.2.3")
...
## 4.2.2[​](#422 "Direct link to 4.2.2")
...
## 4.2.1[​](#421 "Direct link to 4.2.1")
...
## 4.2.0[​](#420 "Direct link to 4.2.0")
...
## 4.1.7[​](#417 "Direct link to 4.1.7")
...
## 4.1.6[​](#416 "Direct link to 4.1.6")
...
## 4.1.5[​](#415 "Direct link to 4.1.5")
...
## 4.1.4[​](#414 "Direct link to 4.1.4")
...
## 4.1.3[​](#413 "Direct link to 4.1.3")
...
## 4.1.2[​](#412 "Direct link to 4.1.2")
...
## 4.1.0[​](#410 "Direct link to 4.1.0")
...
Developers can now leverage the power of Plugins in Lightweight Charts. Two types of Plugins are supported -  [Custom Series](/lightweight-charts/docs/plugins/intro#custom-series) and [Drawing Primitives](/lightweight-charts/docs/plugins/intro#primitives), offering the ability to define new series types and create custom visualizations, drawing tools, and annotations.
...
The [createChartEx](/lightweight-charts/docs/api/functions/createChartEx) function should be used instead of the usual `createChart` function, and an instance of a class implementing [IHorzScaleBehavior](/lightweight-charts/docs/api/interfaces/IHorzScaleBehavior) should be provided.
...
* Added point markers styling option for line-based series. (closes [#365](https://github.com/tradingview/lightweight-charts/issues/365)) [Docs](/lightweight-charts/docs/api/interfaces/LineStyleOptions#pointmarkersvisible)
* Added double click subscriber for the main chart pane. (closes [#1385](https://github.com/tradingview/lightweight-charts/issues/1385)) [Docs](/lightweight-charts/docs/api/interfaces/IChartApi#subscribedblclick)
* Added `setCrosshairPosition` API, allowing programmatic setting of the crosshair position. (fixes [#1198](https://github.com/tradingview/lightweight-charts/issues/1198), [#1163](https://github.com/tradingview/lightweight-charts/issues/1163), [#438](https://github.com/tradingview/lightweight-charts/issues/438)) [Docs](/lightweight-charts/docs/api/interfaces/IChartApi#setcrosshairposition)
...
* Allow overriding tick mark label length via the `tickMarkMaxCharacterLength` option. (closes [#1396](https://github.com/tradingview/lightweight-charts/issues/1396)) [Docs](/lightweight-charts/docs/api/interfaces/HorzScaleOptions#tickmarkmaxcharacterlength)
* Support for overriding the percentage formatter within the localization options. (fixes [#1328](https://github.com/tradingview/lightweight-charts/issues/1328), [#1291](https://github.com/tradingview/lightweight-charts/issues/1291)) [Docs](/lightweight-charts/docs/api/interfaces/LocalizationOptions#percentageformatter)
* Added `paneSize` getter to `IChartApi`, returning the dimensions of the chart pane. (issue [#1411](https://github.com/tradingview/lightweight-charts/issues/1411)) [Docs](/lightweight-charts/docs/api/interfaces/IChartApi#panesize)
* Added options to set minimum dimensions for the price and time scales. (closes [#1062](https://github.com/tradingview/lightweight-charts/issues/1062), related to [#1163](https://github.com/tradingview/lightweight-charts/issues/1163), [#50](https://github.com/tradingview/lightweight-charts/issues/50)) [Docs](/lightweight-charts/docs/api/interfaces/TimeScaleOptions#minimumheight), [Docs](/lightweight-charts/docs/api/interfaces/PriceScaleOptions#minimumwidth)
...
## 4.0.1[​](#401 "Direct link to 4.0.1")
...
Please view the migration guide here: [Migrating from v3 to v4](/lightweight-charts/docs/migrations/from-v3-to-v4).
...
## 3.8.0[​](#380 "Direct link to 3.8.0")
...
## 3.7.0[​](#370 "Direct link to 3.7.0")
...
## 3.6.1[​](#361 "Direct link to 3.6.1")
...
## 3.6.0[​](#360 "Direct link to 3.6.0")
...
## 3.5.0[​](#350 "Direct link to 3.5.0")
...
## 3.4.0[​](#340 "Direct link to 3.4.0")
...
## 3.1.5[​](#315 "Direct link to 3.1.5")
...
## 3.1.3[​](#313 "Direct link to 3.1.3")
...
## 3.0.1[​](#301 "Direct link to 3.0.1")
