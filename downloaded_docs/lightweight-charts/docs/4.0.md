...
First of all, Lightweight Charts™ is *a client-side* library.
This means that it does not and cannot work on the server-side (i.e. NodeJS), at least out of the box.

The code of `lightweight-charts` package is targeted to [*es2016* language specification](https://262.ecma-international.org/7.0/).
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Dependencies included Mode ES module CommonJS ⚠️ IIFE (`window.LightweightCharts`)|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | No PROD `lightweight-charts.production.mjs` `lightweight-charts.production.cjs` N/A|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | No DEV `lightweight-charts.development.mjs` `lightweight-charts.development.cjs` N/A|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | Yes (standalone) PROD `lightweight-charts.standalone.production.mjs` - `lightweight-charts.standalone.production.js`| Yes (standalone) DEV `lightweight-charts.standalone.development.mjs` - `lightweight-charts.standalone.development.js` | | | | | | | | | | | | | | | | | | | | | | | | |
...
[`createChart`](/lightweight-charts/docs/4.0/api/functions/createChart) is the entry-point for creating charts. You can use it to create as many charts as you need:
...
The result of this function is a [`IChartApi`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi) object, which you need to use to work with a chart instance.
...
The basic primitive to display a data is [a series](/lightweight-charts/docs/4.0/api/interfaces/ISeriesApi).
...
To create a series with desired type you need to use appropriate method from [`IChartApi`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi).
...
Please look at [this page](/lightweight-charts/docs/4.0/series-types) for more information about different series types.
...
To set the data (or to replace all data items) to a series you need to use [`ISeriesApi.setData`](/lightweight-charts/docs/4.0/api/interfaces/ISeriesApi#setdata) method:
...
But using [`ISeriesApi.setData`](/lightweight-charts/docs/4.0/api/interfaces/ISeriesApi#setdata) very often might affect the performance and we do not recommend to do this.
Also it replaces all series data with the new one, and probably this is not what you're looking for.

Thus, to update the data you can use a method [`ISeriesApi.update`](/lightweight-charts/docs/4.0/api/interfaces/ISeriesApi#update).
