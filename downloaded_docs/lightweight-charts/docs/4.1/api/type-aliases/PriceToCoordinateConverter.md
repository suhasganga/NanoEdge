...
> **PriceToCoordinateConverter**: (`price`) => [`Coordinate`](/lightweight-charts/docs/4.1/api/type-aliases/Coordinate) | `null`
...
[`Coordinate`](/lightweight-charts/docs/4.1/api/type-aliases/Coordinate) | `null`