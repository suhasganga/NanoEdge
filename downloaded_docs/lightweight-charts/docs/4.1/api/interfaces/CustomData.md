...
* [`CustomSeriesWhitespaceData`](/lightweight-charts/docs/4.1/api/interfaces/CustomSeriesWhitespaceData)<`HorzScaleItem`>
...
[`CustomSeriesWhitespaceData`](/lightweight-charts/docs/4.1/api/interfaces/CustomSeriesWhitespaceData) . [`time`](/lightweight-charts/docs/4.1/api/interfaces/CustomSeriesWhitespaceData#time)
...
[`CustomSeriesWhitespaceData`](/lightweight-charts/docs/4.1/api/interfaces/CustomSeriesWhitespaceData) . [`customValues`](/lightweight-charts/docs/4.1/api/interfaces/CustomSeriesWhitespaceData#customvalues)