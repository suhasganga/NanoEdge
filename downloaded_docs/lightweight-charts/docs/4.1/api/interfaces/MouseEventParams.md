...
> `optional` **logical**: [`Logical`](/lightweight-charts/docs/4.1/api/type-aliases/Logical)
...
> `optional` **point**: [`Point`](/lightweight-charts/docs/4.1/api/interfaces/Point)
...
The [ISeriesApi](/lightweight-charts/docs/4.1/api/interfaces/ISeriesApi) for the series at the point of the mouse event.
...
> `optional` **sourceEvent**: [`TouchMouseEventData`](/lightweight-charts/docs/4.1/api/interfaces/TouchMouseEventData)
