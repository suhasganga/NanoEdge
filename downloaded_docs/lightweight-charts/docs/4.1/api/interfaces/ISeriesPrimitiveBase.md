...
> `optional` **priceAxisViews**(): readonly [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveAxisView)[]

Returns array of labels to be drawn on the price axis used by the series

#### Returns[​](#returns-1 "Direct link to Returns")

readonly [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveAxisView)[]
...
> `optional` **timeAxisViews**(): readonly [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveAxisView)[]
...
> `optional` **paneViews**(): readonly [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView)[]

Returns array of objects representing primitive in the main area of the chart

#### Returns[​](#returns-3 "Direct link to Returns")

readonly [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView)[]
...
> `optional` **priceAxisPaneViews**(): readonly [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView)[]
...
> `optional` **timeAxisPaneViews**(): readonly [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView)[]
...
> `optional` **autoscaleInfo**(`startTimePoint`, `endTimePoint`): [`AutoscaleInfo`](/lightweight-charts/docs/4.1/api/interfaces/AutoscaleInfo)
...
• **startTimePoint**: [`Logical`](/lightweight-charts/docs/4.1/api/type-aliases/Logical)

start time point for the current visible range

• **endTimePoint**: [`Logical`](/lightweight-charts/docs/4.1/api/type-aliases/Logical)

end time point for the current visible range

#### Returns[​](#returns-6 "Direct link to Returns")

[`AutoscaleInfo`](/lightweight-charts/docs/4.1/api/interfaces/AutoscaleInfo)
...
> `optional` **hitTest**(`x`, `y`): [`PrimitiveHoveredItem`](/lightweight-charts/docs/4.1/api/interfaces/PrimitiveHoveredItem)
...
[`PrimitiveHoveredItem`](/lightweight-charts/docs/4.1/api/interfaces/PrimitiveHoveredItem)