...
> **width**: [`LineWidth`](/lightweight-charts/docs/4.1/api/type-aliases/LineWidth)
...
> **style**: [`LineStyle`](/lightweight-charts/docs/4.1/api/enumerations/LineStyle)
...
* [LineStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/4.1/api/interfaces/LineStyleOptions#crosshairmarkervisible)
* [AreaStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/4.1/api/interfaces/AreaStyleOptions#crosshairmarkervisible)
* [BaselineStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/4.1/api/interfaces/BaselineStyleOptions#crosshairmarkervisible)
