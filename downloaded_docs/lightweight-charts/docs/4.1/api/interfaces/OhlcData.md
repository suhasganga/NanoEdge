...
Represents a bar with a [Time](/lightweight-charts/docs/4.1/api/type-aliases/Time) and open, high, low, and close prices.
...
* [`BarData`](/lightweight-charts/docs/4.1/api/interfaces/BarData)
* [`CandlestickData`](/lightweight-charts/docs/4.1/api/interfaces/CandlestickData)
