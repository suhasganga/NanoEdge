...
> **bars**: readonly [`CustomBarItemData`](/lightweight-charts/docs/4.1/api/interfaces/CustomBarItemData)<`HorzScaleItem`, `TData`>[]
...
> **visibleRange**: [`Range`](/lightweight-charts/docs/4.1/api/interfaces/Range)<`number`>
