...
> **mode**: [`PriceScaleMode`](/lightweight-charts/docs/4.1/api/enumerations/PriceScaleMode)
...
> **scaleMargins**: [`PriceScaleMargins`](/lightweight-charts/docs/4.1/api/interfaces/PriceScaleMargins)
...
If not provided [LayoutOptions.textColor](/lightweight-charts/docs/4.1/api/interfaces/LayoutOptions#textcolor) is used.
