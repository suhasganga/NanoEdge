...
> **priceLineSource**: [`PriceLineSource`](/lightweight-charts/docs/4.1/api/enumerations/PriceLineSource)
...
> **priceLineWidth**: [`LineWidth`](/lightweight-charts/docs/4.1/api/type-aliases/LineWidth)
...
> **priceLineStyle**: [`LineStyle`](/lightweight-charts/docs/4.1/api/enumerations/LineStyle)
...
> **priceFormat**: [`PriceFormat`](/lightweight-charts/docs/4.1/api/type-aliases/PriceFormat)
...
> **baseLineWidth**: [`LineWidth`](/lightweight-charts/docs/4.1/api/type-aliases/LineWidth)
...
> **baseLineStyle**: [`LineStyle`](/lightweight-charts/docs/4.1/api/enumerations/LineStyle)
...
> `optional` **autoscaleInfoProvider**: [`AutoscaleInfoProvider`](/lightweight-charts/docs/4.1/api/type-aliases/AutoscaleInfoProvider)

Override the default [AutoscaleInfo](/lightweight-charts/docs/4.1/api/interfaces/AutoscaleInfo) provider.
