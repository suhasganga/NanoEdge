...
> **index**: [`TimePointIndex`](/lightweight-charts/docs/4.1/api/type-aliases/TimePointIndex)
...
> **weight**: [`TickMarkWeightValue`](/lightweight-charts/docs/4.1/api/type-aliases/TickMarkWeightValue)
