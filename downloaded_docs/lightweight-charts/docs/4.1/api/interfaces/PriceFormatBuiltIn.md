...
`2` if both [minMove](/lightweight-charts/docs/4.1/api/interfaces/PriceFormatBuiltIn#minmove) and [precision](/lightweight-charts/docs/4.1/api/interfaces/PriceFormatBuiltIn#precision) are not provided, calculated automatically based on [minMove](/lightweight-charts/docs/4.1/api/interfaces/PriceFormatBuiltIn#minmove) otherwise.
