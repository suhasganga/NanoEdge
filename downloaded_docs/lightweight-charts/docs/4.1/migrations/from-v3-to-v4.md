...
Please use [`LastPriceAnimationMode`](/lightweight-charts/docs/4.1/api/enumerations/LastPriceAnimationMode) instead.
...
If you want to have solid background color you need to use [`background`](/lightweight-charts/docs/4.1/api/interfaces/LayoutOptions#background) property instead, e.g. instead of:
...
Please follow [the guide for migrating from v2 to v3](/lightweight-charts/docs/4.1/migrations/from-v2-to-v3#creating-overlay) where this option was deprecated.

## `priceScale` option has been removed[​](#pricescale-option-has-been-removed "Direct link to pricescale-option-has-been-removed")

Please follow [the guide for migrating from v2 to v3](/lightweight-charts/docs/4.1/migrations/from-v2-to-v3#two-price-scales).
...
* [`IChartApi.subscribeClick`](/lightweight-charts/docs/4.1/api/interfaces/IChartApi#subscribeclick) (via [`MouseEventParams.time`](/lightweight-charts/docs/4.1/api/interfaces/MouseEventParams#time))
* [`IChartApi.subscribeCrosshairMove`](/lightweight-charts/docs/4.1/api/interfaces/IChartApi#subscribecrosshairmove) (via [`MouseEventParams.time`](/lightweight-charts/docs/4.1/api/interfaces/MouseEventParams#time))
* [`LocalizationOptions.timeFormatter`](/lightweight-charts/docs/4.1/api/interfaces/LocalizationOptions#timeformatter) (via argument of [`TimeFormatterFn`](/lightweight-charts/docs/4.1/api/type-aliases/TimeFormatterFn))
* [`TimeScaleOptions.tickMarkFormatter`](/lightweight-charts/docs/4.1/api/interfaces/TimeScaleOptions#tickmarkformatter) (via argument of [`TickMarkFormatter`](/lightweight-charts/docs/4.1/api/type-aliases/TickMarkFormatter))

Previously the type of an inbound time (a values you provide to the library, e.g. in [`ISeriesApi.setData`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesApi#setdata)) was different from an outbound one (a values the library provides to your code, e.g. an argument of [`LocalizationOptions.timeFormatter`](/lightweight-charts/docs/4.1/api/interfaces/LocalizationOptions#timeformatter)).
...
Thus, if you provide a string to your series in [`ISeriesApi.setData`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesApi#setdata), you'll receive exactly the same value back:
...
* [`IChartApi.subscribeClick`](/lightweight-charts/docs/4.1/api/interfaces/IChartApi#subscribeclick)
* [`IChartApi.subscribeCrosshairMove`](/lightweight-charts/docs/4.1/api/interfaces/IChartApi#subscribecrosshairmove)

The property `seriesPrices` of [`MouseEventParams`](/lightweight-charts/docs/4.1/api/interfaces/MouseEventParams) has been removed.

Instead, you can use [`MouseEventParams.seriesData`](/lightweight-charts/docs/4.1/api/interfaces/MouseEventParams#seriesdata) - it is pretty similar to the old `seriesPrices`, but it contains series' data items instead of just prices:
