...
[`ISeriesPrimitive`](/lightweight-charts/docs/4.1/api/type-aliases/ISeriesPrimitive) interface. The
...
* [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView)
* [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveAxisView)
...
* [`paneViews`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#paneviews)
* [`priceAxisPaneViews`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#priceaxispaneviews)
* [`timeAxisPaneViews`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#timeaxispaneviews)
* [`priceAxisViews`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#priceaxisviews)
* [`timeAxisViews`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#timeaxisviews)
...
The [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView)
...
[`zOrder`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneView#zorder) to control where
...
[`draw`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneRenderer#draw) method which will
be given a `CanvasRenderingTarget2D` target on which it can draw. Additionally,
a renderer can optionally provide a
[`drawBackground`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitivePaneRenderer#drawbackground)
method for drawing beneath other elements on the same zOrder.

tip

`CanvasRenderingTarget2D` is explained in more detail on the [Canvas Rendering Target](/lightweight-charts/docs/4.1/plugins/canvas-rendering-target) page.
...
The [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveAxisView)
...
[`coordinate`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveAxisView#coordinate) method,
...
[`attached`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#attached) and
[`detached`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#detached) lifecycle methods to
...
[single argument](/lightweight-charts/docs/4.1/api/interfaces/SeriesAttachedParameter) containing
...
[`updateAllViews()`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#updateallviews) method
...
The [`autoscaleInfo()`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesPrimitiveBase#autoscaleinfo)
