...
[Custom Series Types](/lightweight-charts/docs/4.1/plugins/custom_series) article.**
...
[`addCustomSeries`](/lightweight-charts/docs/4.1/api/interfaces/IChartApi#addcustomseries) method
...
[Series Primitives](/lightweight-charts/docs/4.1/plugins/series-primitives) article.**
...
[`attachPrimitive()`](/lightweight-charts/docs/4.1/api/interfaces/ISeriesApi#attachprimitive) method
which expects an instantiated object implementing the
[ISeriesPrimitive](/lightweight-charts/docs/4.1/api/type-aliases/ISeriesPrimitive) interface as the first
argument.
