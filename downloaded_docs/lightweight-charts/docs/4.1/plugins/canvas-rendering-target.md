...
## Using `CanvasRenderingTarget2D`[​](#using-canvasrenderingtarget2d "Direct link to using-canvasrenderingtarget2d")
...
## Difference between Bitmap and Media[​](#difference-between-bitmap-and-media "Direct link to Difference between Bitmap and Media")
...
### Bitmap Coordinate Space[​](#bitmap-coordinate-space "Direct link to Bitmap Coordinate Space")
...
#### Bitmap Coordinate Space Usage[​](#bitmap-coordinate-space-usage "Direct link to Bitmap Coordinate Space Usage")
...
### Media Coordinate Space[​](#media-coordinate-space "Direct link to Media Coordinate Space")
...
#### Media Coordinate Space Usage[​](#media-coordinate-space-usage "Direct link to Media Coordinate Space Usage")
