...
2. You can use [`ISeriesApi.applyOptions`](/lightweight-charts/docs/4.0/api/interfaces/ISeriesApi#applyoptions) method to apply other options on the fly:
...
* **Method to create**: [`IChartApi.addAreaSeries`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi#addareaseries)
* **Data format**: [`SingleValueData`](/lightweight-charts/docs/4.0/api/interfaces/SingleValueData) or [`WhitespaceData`](/lightweight-charts/docs/4.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/4.0/api/interfaces/SeriesOptionsCommon) and [`AreaStyleOptions`](/lightweight-charts/docs/4.0/api/interfaces/AreaStyleOptions)

An area chart is basically a colored area between the line connecting all data points and [the time scale](/lightweight-charts/docs/4.0/time-scale):
...
* **Method to create**: [`IChartApi.addBarSeries`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi#addbarseries)
* **Data format**: [`BarData`](/lightweight-charts/docs/4.0/api/interfaces/BarData) or [`WhitespaceData`](/lightweight-charts/docs/4.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/4.0/api/interfaces/SeriesOptionsCommon) and [`BarStyleOptions`](/lightweight-charts/docs/4.0/api/interfaces/BarStyleOptions)
...
* **Method to create**: [`IChartApi.addBaselineSeries`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi#addbaselineseries)
* **Data format**: [`SingleValueData`](/lightweight-charts/docs/4.0/api/interfaces/SingleValueData) or [`WhitespaceData`](/lightweight-charts/docs/4.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/4.0/api/interfaces/SeriesOptionsCommon) and [`BaselineStyleOptions`](/lightweight-charts/docs/4.0/api/interfaces/BaselineStyleOptions)

A baseline is basically two colored areas (top and bottom) between the line connecting all data points and [the base value line](/lightweight-charts/docs/4.0/api/interfaces/BaselineStyleOptions#basevalue):
...
* **Method to create**: [`IChartApi.addCandlestickSeries`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi#addcandlestickseries)
* **Data format**: [`CandlestickData`](/lightweight-charts/docs/4.0/api/interfaces/CandlestickData) or [`WhitespaceData`](/lightweight-charts/docs/4.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/4.0/api/interfaces/SeriesOptionsCommon) and [`CandlestickStyleOptions`](/lightweight-charts/docs/4.0/api/interfaces/CandlestickStyleOptions)
...
* **Method to create**: [`IChartApi.addHistogramSeries`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi#addhistogramseries)
* **Data format**: [`HistogramData`](/lightweight-charts/docs/4.0/api/interfaces/HistogramData) or [`WhitespaceData`](/lightweight-charts/docs/4.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/4.0/api/interfaces/SeriesOptionsCommon) and [`HistogramStyleOptions`](/lightweight-charts/docs/4.0/api/interfaces/HistogramStyleOptions)
...
* **Method to create**: [`IChartApi.addLineSeries`](/lightweight-charts/docs/4.0/api/interfaces/IChartApi#addlineseries)
* **Data format**: [`LineData`](/lightweight-charts/docs/4.0/api/interfaces/LineData) or [`WhitespaceData`](/lightweight-charts/docs/4.0/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/4.0/api/interfaces/SeriesOptionsCommon) and [`LineStyleOptions`](/lightweight-charts/docs/4.0/api/interfaces/LineStyleOptions)
