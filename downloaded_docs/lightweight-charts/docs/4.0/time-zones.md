...
## How to add time zone support to your chart[​](#how-to-add-time-zone-support-to-your-chart "Direct link to How to add time zone support to your chart")
...
### `Date` solution[​](#date-solution "Direct link to date-solution")
...
#### Note about converting to a "local" time zone[​](#note-about-converting-to-a-local-time-zone "Direct link to Note about converting to a \"local\" time zone")
...
### `date-fns-tz` solution[​](#date-fns-tz-solution "Direct link to date-fns-tz-solution")
...
### `tzdata` solution[​](#tzdata-solution "Direct link to tzdata-solution")
...
## Why we didn't implement it in the library[​](#why-we-didnt-implement-it-in-the-library "Direct link to Why we didn't implement it in the library")
...
## Note about converting business days[​](#note-about-converting-business-days "Direct link to Note about converting business days")

If you're using a business day for your time (either [object](/lightweight-charts/docs/4.0/api/interfaces/BusinessDay) or [string](/lightweight-charts/docs/4.0/api/type-aliases/Time) representation), for example because of DWM nature of your data,
