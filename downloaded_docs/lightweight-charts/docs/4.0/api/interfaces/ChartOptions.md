...
> **watermark**: [`WatermarkOptions`](/lightweight-charts/docs/4.0/api/interfaces/WatermarkOptions)
...
> **layout**: [`LayoutOptions`](/lightweight-charts/docs/4.0/api/interfaces/LayoutOptions)
...
> **leftPriceScale**: [`PriceScaleOptions`](/lightweight-charts/docs/4.0/api/interfaces/PriceScaleOptions)
...
> **rightPriceScale**: [`PriceScaleOptions`](/lightweight-charts/docs/4.0/api/interfaces/PriceScaleOptions)
...
> **overlayPriceScales**: [`OverlayPriceScaleOptions`](/lightweight-charts/docs/4.0/api/type-aliases/OverlayPriceScaleOptions)
...
> **timeScale**: [`TimeScaleOptions`](/lightweight-charts/docs/4.0/api/interfaces/TimeScaleOptions)
...
> **crosshair**: [`CrosshairOptions`](/lightweight-charts/docs/4.0/api/interfaces/CrosshairOptions)
...
> **grid**: [`GridOptions`](/lightweight-charts/docs/4.0/api/interfaces/GridOptions)
...
> **localization**: [`LocalizationOptions`](/lightweight-charts/docs/4.0/api/interfaces/LocalizationOptions)
...
> **handleScroll**: `boolean` | [`HandleScrollOptions`](/lightweight-charts/docs/4.0/api/interfaces/HandleScrollOptions)
...
> **handleScale**: `boolean` | [`HandleScaleOptions`](/lightweight-charts/docs/4.0/api/interfaces/HandleScaleOptions)
...
> **kineticScroll**: [`KineticScrollOptions`](/lightweight-charts/docs/4.0/api/interfaces/KineticScrollOptions)
...
> **trackingMode**: [`TrackingModeOptions`](/lightweight-charts/docs/4.0/api/interfaces/TrackingModeOptions)
