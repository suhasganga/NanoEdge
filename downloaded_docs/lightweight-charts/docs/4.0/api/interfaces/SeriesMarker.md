...
> **position**: [`SeriesMarkerPosition`](/lightweight-charts/docs/4.0/api/type-aliases/SeriesMarkerPosition)
...
> **shape**: [`SeriesMarkerShape`](/lightweight-charts/docs/4.0/api/type-aliases/SeriesMarkerShape)
