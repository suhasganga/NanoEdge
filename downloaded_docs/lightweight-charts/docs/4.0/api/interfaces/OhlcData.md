...
Represents a bar with a [Time](/lightweight-charts/docs/4.0/api/type-aliases/Time) and open, high, low, and close prices.

## Extended by[​](#extended-by "Direct link to Extended by")

* [`BarData`](/lightweight-charts/docs/4.0/api/interfaces/BarData)
* [`CandlestickData`](/lightweight-charts/docs/4.0/api/interfaces/CandlestickData)
