...
To create a chart, use the [`createChart`](/lightweight-charts/docs/5.0/api/functions/createChart) function. You can call the function multiple times to create as many charts as needed:
...
As a result, `createChart` returns an [`IChartApi`](/lightweight-charts/docs/5.0/api/interfaces/IChartApi) object that allows you to interact with the created chart.

## Creating a series[​](#creating-a-series "Direct link to Creating a series")

When the chart is created, you can display data on it.

The basic primitive to display data is a [series](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi).
...
To create a series, use the [`addSeries`](/lightweight-charts/docs/5.0/api/interfaces/IChartApi#addseries) method from [`IChartApi`](/lightweight-charts/docs/5.0/api/interfaces/IChartApi).
As a parameter, specify a [series type](/lightweight-charts/docs/5.0/series-types) you would like to create:
...
To set the data to a series, you should call the [`ISeriesApi.setData`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi#setdata) method:
...
To do this, call the [`ISeriesApi.update`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi#update) method that allows you to update the last data item or add a new one.
...
We do not recommend calling [`ISeriesApi.setData`](/lightweight-charts/docs/5.0/api/interfaces/ISeriesApi#setdata) to update the chart, as this method replaces all series data and can significantly affect the performance.