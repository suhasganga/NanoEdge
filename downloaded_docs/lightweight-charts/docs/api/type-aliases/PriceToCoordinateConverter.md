...
> **PriceToCoordinateConverter**: (`price`) => [`Coordinate`](/lightweight-charts/docs/api/type-aliases/Coordinate) | `null`
...
[`Coordinate`](/lightweight-charts/docs/api/type-aliases/Coordinate) | `null`