...
> **priceLineSource**: [`PriceLineSource`](/lightweight-charts/docs/api/enumerations/PriceLineSource)
...
> **priceLineWidth**: [`LineWidth`](/lightweight-charts/docs/api/type-aliases/LineWidth)
...
> **priceLineStyle**: [`LineStyle`](/lightweight-charts/docs/api/enumerations/LineStyle)
...
> **priceFormat**: [`PriceFormat`](/lightweight-charts/docs/api/type-aliases/PriceFormat)
...
> **baseLineWidth**: [`LineWidth`](/lightweight-charts/docs/api/type-aliases/LineWidth)
...
> **baseLineStyle**: [`LineStyle`](/lightweight-charts/docs/api/enumerations/LineStyle)
...
> `optional` **autoscaleInfoProvider**: [`AutoscaleInfoProvider`](/lightweight-charts/docs/api/type-aliases/AutoscaleInfoProvider)

Override the default [AutoscaleInfo](/lightweight-charts/docs/api/interfaces/AutoscaleInfo) provider.
