...
> **axisPressedMouseMove**: `boolean` | [`AxisPressedMouseMoveOptions`](/lightweight-charts/docs/api/interfaces/AxisPressedMouseMoveOptions)
...
> **axisDoubleClickReset**: `boolean` | [`AxisDoubleClickOptions`](/lightweight-charts/docs/api/interfaces/AxisDoubleClickOptions)
