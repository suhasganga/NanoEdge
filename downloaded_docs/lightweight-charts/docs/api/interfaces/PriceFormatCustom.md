...
> **formatter**: [`PriceFormatterFn`](/lightweight-charts/docs/api/type-aliases/PriceFormatterFn)
...
> `optional` **tickmarksFormatter**: [`TickmarksPriceFormatterFn`](/lightweight-charts/docs/api/type-aliases/TickmarksPriceFormatterFn)
...
The base value for the price format. It should equal to 1 / [minMove](/lightweight-charts/docs/api/interfaces/PriceFormatCustom#minmove).
If this option is specified, we ignore the [minMove](/lightweight-charts/docs/api/interfaces/PriceFormatCustom#minmove) option.
