...
> **bars**: readonly [`CustomBarItemData`](/lightweight-charts/docs/api/interfaces/CustomBarItemData)<`HorzScaleItem`, `TData`>[]
...
> **visibleRange**: [`IRange`](/lightweight-charts/docs/api/interfaces/IRange)<`number`>
