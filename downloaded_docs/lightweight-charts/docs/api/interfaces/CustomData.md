...
* [`CustomSeriesWhitespaceData`](/lightweight-charts/docs/api/interfaces/CustomSeriesWhitespaceData)<`HorzScaleItem`>
...
[`CustomSeriesWhitespaceData`](/lightweight-charts/docs/api/interfaces/CustomSeriesWhitespaceData) . [`time`](/lightweight-charts/docs/api/interfaces/CustomSeriesWhitespaceData#time)
...
[`CustomSeriesWhitespaceData`](/lightweight-charts/docs/api/interfaces/CustomSeriesWhitespaceData) . [`customValues`](/lightweight-charts/docs/api/interfaces/CustomSeriesWhitespaceData#customvalues)