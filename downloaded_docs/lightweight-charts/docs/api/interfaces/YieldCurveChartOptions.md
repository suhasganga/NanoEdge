...
> **localization**: [`LocalizationOptions`](/lightweight-charts/docs/api/interfaces/LocalizationOptions)<`number`>
...
> **yieldCurve**: [`YieldCurveOptions`](/lightweight-charts/docs/api/interfaces/YieldCurveOptions)
