...
> **width**: [`LineWidth`](/lightweight-charts/docs/api/type-aliases/LineWidth)
...
> **style**: [`LineStyle`](/lightweight-charts/docs/api/enumerations/LineStyle)
...
* [LineStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/api/interfaces/LineStyleOptions#crosshairmarkervisible)
* [AreaStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/api/interfaces/AreaStyleOptions#crosshairmarkervisible)
* [BaselineStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/api/interfaces/BaselineStyleOptions#crosshairmarkervisible)
