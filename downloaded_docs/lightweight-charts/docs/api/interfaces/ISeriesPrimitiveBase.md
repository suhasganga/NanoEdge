...
> `optional` **priceAxisViews**(): readonly [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/api/interfaces/ISeriesPrimitiveAxisView)[]

Returns array of labels to be drawn on the price axis used by the series

#### Returns[​](#returns-1 "Direct link to Returns")

readonly [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/api/interfaces/ISeriesPrimitiveAxisView)[]
...
> `optional` **timeAxisViews**(): readonly [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/api/interfaces/ISeriesPrimitiveAxisView)[]
...
> `optional` **paneViews**(): readonly [`IPrimitivePaneView`](/lightweight-charts/docs/api/interfaces/IPrimitivePaneView)[]

Returns array of objects representing primitive in the main area of the chart

#### Returns[​](#returns-3 "Direct link to Returns")

readonly [`IPrimitivePaneView`](/lightweight-charts/docs/api/interfaces/IPrimitivePaneView)[]
...
> `optional` **priceAxisPaneViews**(): readonly [`IPrimitivePaneView`](/lightweight-charts/docs/api/interfaces/IPrimitivePaneView)[]
...
> `optional` **timeAxisPaneViews**(): readonly [`IPrimitivePaneView`](/lightweight-charts/docs/api/interfaces/IPrimitivePaneView)[]
...
> `optional` **autoscaleInfo**(`startTimePoint`, `endTimePoint`): [`AutoscaleInfo`](/lightweight-charts/docs/api/interfaces/AutoscaleInfo)
...
• **startTimePoint**: [`Logical`](/lightweight-charts/docs/api/type-aliases/Logical)

start time point for the current visible range

• **endTimePoint**: [`Logical`](/lightweight-charts/docs/api/type-aliases/Logical)
...
> `optional` **hitTest**(`x`, `y`): [`PrimitiveHoveredItem`](/lightweight-charts/docs/api/interfaces/PrimitiveHoveredItem)
