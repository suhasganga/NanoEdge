...
If you want to change `left` price scale, you need to use [`leftPriceScale`](/lightweight-charts/docs/4.2/api/interfaces/ChartOptionsBase#leftpricescale) option, to change `right` price scale use [`rightPriceScale`](/lightweight-charts/docs/4.2/api/interfaces/ChartOptionsBase#rightpricescale), to change default options for an overlay price scale use [`overlayPriceScales`](/lightweight-charts/docs/4.2/api/interfaces/ChartOptionsBase#overlaypricescales) option.

Alternatively, you can use [`IChartApi.priceScale`](/lightweight-charts/docs/4.2/api/interfaces/IChartApi#pricescale) method to get an API object of any price scale or [`ISeriesApi.priceScale`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesApi#pricescale) to get an API object of series' price scale (the price scale that the series is attached to).
