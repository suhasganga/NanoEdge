...
> **position**: [`SeriesMarkerPosition`](/lightweight-charts/docs/4.2/api/type-aliases/SeriesMarkerPosition)
...
> **shape**: [`SeriesMarkerShape`](/lightweight-charts/docs/4.2/api/type-aliases/SeriesMarkerShape)
