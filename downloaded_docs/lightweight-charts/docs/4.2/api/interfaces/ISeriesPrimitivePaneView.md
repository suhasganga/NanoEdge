...
> `optional` **zOrder**(): [`SeriesPrimitivePaneViewZOrder`](/lightweight-charts/docs/4.2/api/type-aliases/SeriesPrimitivePaneViewZOrder)
...
> **renderer**(): [`ISeriesPrimitivePaneRenderer`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitivePaneRenderer)
