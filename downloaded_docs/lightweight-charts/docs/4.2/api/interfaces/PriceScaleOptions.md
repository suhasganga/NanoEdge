...
> **mode**: [`PriceScaleMode`](/lightweight-charts/docs/4.2/api/enumerations/PriceScaleMode)
...
> **scaleMargins**: [`PriceScaleMargins`](/lightweight-charts/docs/4.2/api/interfaces/PriceScaleMargins)
...
If not provided [LayoutOptions.textColor](/lightweight-charts/docs/4.2/api/interfaces/LayoutOptions#textcolor) is used.
