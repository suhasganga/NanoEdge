...
* [`SingleValueData`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData)<`HorzScaleItem`>
...
[`SingleValueData`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData) . [`time`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData#time)
...
[`SingleValueData`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData) . [`value`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData#value)
...
[`SingleValueData`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData) . [`customValues`](/lightweight-charts/docs/4.2/api/interfaces/SingleValueData#customvalues)