...
> **baseValue**: [`BaseValuePrice`](/lightweight-charts/docs/4.2/api/interfaces/BaseValuePrice)
...
> **lineWidth**: [`LineWidth`](/lightweight-charts/docs/4.2/api/type-aliases/LineWidth)
...
> **lineStyle**: [`LineStyle`](/lightweight-charts/docs/4.2/api/enumerations/LineStyle)
...
> **lineType**: [`LineType`](/lightweight-charts/docs/4.2/api/enumerations/LineType)
...
> **lastPriceAnimation**: [`LastPriceAnimationMode`](/lightweight-charts/docs/4.2/api/enumerations/LastPriceAnimationMode)
