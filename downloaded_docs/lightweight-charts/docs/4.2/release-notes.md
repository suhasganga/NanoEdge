...
Developers can now leverage the power of Plugins in Lightweight Charts. Two types of Plugins are supported -  [Custom Series](/lightweight-charts/docs/4.2/plugins/intro#custom-series) and [Drawing Primitives](/lightweight-charts/docs/4.2/plugins/intro#drawing-primitives), offering the ability to define new series types and create custom visualizations, drawing tools, and annotations.
...
The [createChartEx](/lightweight-charts/docs/4.2/api/functions/createChartEx) function should be used instead of the usual `createChart` function, and an instance of a class implementing [IHorzScaleBehavior](/lightweight-charts/docs/4.2/api/interfaces/IHorzScaleBehavior) should be provided.
...
* Added point markers styling option for line-based series. (closes [#365](https://github.com/tradingview/lightweight-charts/issues/365)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/LineStyleOptions#pointmarkersvisible)
* Added double click subscriber for the main chart pane. (closes [#1385](https://github.com/tradingview/lightweight-charts/issues/1385)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/IChartApi#subscribedblclick)
* Added `setCrosshairPosition` API, allowing programmatic setting of the crosshair position. (fixes [#1198](https://github.com/tradingview/lightweight-charts/issues/1198), [#1163](https://github.com/tradingview/lightweight-charts/issues/1163), [#438](https://github.com/tradingview/lightweight-charts/issues/438)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/IChartApi#setcrosshairposition)
...
* Allow overriding tick mark label length via the `tickMarkMaxCharacterLength` option. (closes [#1396](https://github.com/tradingview/lightweight-charts/issues/1396)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/HorzScaleOptions#tickmarkmaxcharacterlength)
* Support for overriding the percentage formatter within the localization options. (fixes [#1328](https://github.com/tradingview/lightweight-charts/issues/1328), [#1291](https://github.com/tradingview/lightweight-charts/issues/1291)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/LocalizationOptions#percentageformatter)
* Added `paneSize` getter to `IChartApi`, returning the dimensions of the chart pane. (issue [#1411](https://github.com/tradingview/lightweight-charts/issues/1411)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/IChartApi#panesize)
* Added options to set minimum dimensions for the price and time scales. (closes [#1062](https://github.com/tradingview/lightweight-charts/issues/1062), related to [#1163](https://github.com/tradingview/lightweight-charts/issues/1163), [#50](https://github.com/tradingview/lightweight-charts/issues/50)) [Docs](/lightweight-charts/docs/4.2/api/interfaces/TimeScaleOptions#minimumheight), [Docs](/lightweight-charts/docs/4.2/api/interfaces/PriceScaleOptions#minimumwidth)
...
Please view the migration guide here: [Migrating from v3 to v4](/lightweight-charts/docs/4.2/migrations/from-v3-to-v4).
