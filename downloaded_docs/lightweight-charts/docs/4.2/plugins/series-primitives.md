...
[`ISeriesPrimitive`](/lightweight-charts/docs/4.2/api/type-aliases/ISeriesPrimitive) interface. The
...
* [`paneViews`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#paneviews)
* [`priceAxisPaneViews`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#priceaxispaneviews)
* [`timeAxisPaneViews`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#timeaxispaneviews)
* [`priceAxisViews`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#priceaxisviews)
* [`timeAxisViews`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#timeaxisviews)
...
### ISeriesPrimitivePaneView[​](#iseriesprimitivepaneview "Direct link to ISeriesPrimitivePaneView")

The [`ISeriesPrimitivePaneView`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitivePaneView)
...
[`zOrder`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitivePaneView#zorder) to control where
...
[`draw`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitivePaneRenderer#draw) method which will
be given a `CanvasRenderingTarget2D` target on which it can draw. Additionally,
a renderer can optionally provide a
[`drawBackground`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitivePaneRenderer#drawbackground)
method for drawing beneath other elements on the same zOrder.

tip

`CanvasRenderingTarget2D` is explained in more detail on the [Canvas Rendering Target](/lightweight-charts/docs/4.2/plugins/canvas-rendering-target) page.

#### Interactive Demo of zOrder layers[​](#interactive-demo-of-zorder-layers "Direct link to Interactive Demo of zOrder layers")
...
### ISeriesPrimitiveAxisView[​](#iseriesprimitiveaxisview "Direct link to ISeriesPrimitiveAxisView")

The [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveAxisView)
...
[`coordinate`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveAxisView#coordinate) method,
...
## Lifecycle Methods[​](#lifecycle-methods "Direct link to Lifecycle Methods")

Your primitive can use the
[`attached`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#attached) and
[`detached`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#detached) lifecycle methods to
...
[single argument](/lightweight-charts/docs/4.2/api/interfaces/SeriesAttachedParameter) containing
...
## Updating Views[​](#updating-views "Direct link to Updating Views")

Your primitive should update the views in the
[`updateAllViews()`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#updateallviews) method
...
## Extending the Autoscale Info[​](#extending-the-autoscale-info "Direct link to Extending the Autoscale Info")

The [`autoscaleInfo()`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesPrimitiveBase#autoscaleinfo)
