...
[`CustomData`](/lightweight-charts/docs/4.2/api/interfaces/CustomData) interface (have a valid time
...
[`ICustomSeriesPaneView`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView) interface.
...
* ICustomSeriesPaneView property:
  [`renderer`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView#renderer)
...
The [`draw`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneRenderer#draw) method of the
renderer is evoked whenever the chart needs to draw the series.

The [`PriceToCoordinateConverter`](/lightweight-charts/docs/4.2/api/type-aliases/PriceToCoordinateConverter)
...
more detail on the [Canvas Rendering Target](/lightweight-charts/docs/4.2/plugins/canvas-rendering-target) page.

### Update[​](#update "Direct link to Update")

* ICustomSeriesPaneView property:
  [`update`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView#update)
...
The [`PaneRendererCustomData`](/lightweight-charts/docs/4.2/api/interfaces/PaneRendererCustomData)
...
* `bars`: List of all the series' items and their x coordinates. See
  [`CustomBarItemData`](/lightweight-charts/docs/4.2/api/interfaces/CustomBarItemData) for more details
...
* ICustomSeriesPaneView property:
  [`priceValueBuilder`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView#pricevaluebuilder)
...
* ICustomSeriesPaneView property:
  [`isWhitespace`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView#iswhitespace)
...
* ICustomSeriesPaneView property:
  [`defaultOptions`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView#defaultoptions)

The default options to be used for the series. The user can override these
values using the options argument in
[`addCustomSeries`](/lightweight-charts/docs/4.2/api/interfaces/IChartApi#addcustomseries), or via the
[`applyOptions`](/lightweight-charts/docs/4.2/api/interfaces/ISeriesApi#applyoptions) method on the
`ISeriesAPI`.

### Destroy[​](#destroy "Direct link to Destroy")

* ICustomSeriesPaneView property:
  [`destroy`](/lightweight-charts/docs/4.2/api/interfaces/ICustomSeriesPaneView#destroy)
