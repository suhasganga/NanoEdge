...
> `optional` **priceFormatter**: [`PriceFormatterFn`](/lightweight-charts/docs/3.8/api/type-aliases/PriceFormatterFn)
...
> `optional` **timeFormatter**: [`TimeFormatterFn`](/lightweight-charts/docs/3.8/api/type-aliases/TimeFormatterFn)
...
Ignored if [timeFormatter](/lightweight-charts/docs/3.8/api/interfaces/LocalizationOptions#timeformatter) has been specified.
