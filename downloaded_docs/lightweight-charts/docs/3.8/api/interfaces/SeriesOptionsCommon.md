...
> **priceLineSource**: [`PriceLineSource`](/lightweight-charts/docs/3.8/api/enumerations/PriceLineSource)
...
> **priceLineWidth**: [`LineWidth`](/lightweight-charts/docs/3.8/api/type-aliases/LineWidth)
...
> **priceLineStyle**: [`LineStyle`](/lightweight-charts/docs/3.8/api/enumerations/LineStyle)
...
> **priceFormat**: [`PriceFormat`](/lightweight-charts/docs/3.8/api/type-aliases/PriceFormat)
...
> **baseLineWidth**: [`LineWidth`](/lightweight-charts/docs/3.8/api/type-aliases/LineWidth)
...
> **baseLineStyle**: [`LineStyle`](/lightweight-charts/docs/3.8/api/enumerations/LineStyle)
...
> `optional` **autoscaleInfoProvider**: [`AutoscaleInfoProvider`](/lightweight-charts/docs/3.8/api/type-aliases/AutoscaleInfoProvider)

Override the default [AutoscaleInfo](/lightweight-charts/docs/3.8/api/interfaces/AutoscaleInfo) provider.
...
> `optional` **scaleMargins**: [`PriceScaleMargins`](/lightweight-charts/docs/3.8/api/interfaces/PriceScaleMargins)

#### Deprecated[​](#deprecated "Direct link to Deprecated")

Use [ISeriesApi.priceScale](/lightweight-charts/docs/3.8/api/interfaces/ISeriesApi#pricescale) method of the series to apply options instead.