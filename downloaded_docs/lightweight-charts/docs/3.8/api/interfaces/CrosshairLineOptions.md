...
> **width**: [`LineWidth`](/lightweight-charts/docs/3.8/api/type-aliases/LineWidth)
...
> **style**: [`LineStyle`](/lightweight-charts/docs/3.8/api/enumerations/LineStyle)
...
* [LineStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/3.8/api/interfaces/LineStyleOptions#crosshairmarkervisible)
* [AreaStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/3.8/api/interfaces/AreaStyleOptions#crosshairmarkervisible)
* [BaselineStyleOptions.crosshairMarkerVisible](/lightweight-charts/docs/3.8/api/interfaces/BaselineStyleOptions#crosshairmarkervisible)
