...
> **createOptionsChart**(`container`, `options`?): [`IChartApiBase`](/lightweight-charts/docs/next/api/interfaces/IChartApiBase)<`number`>
...
• **options?**: [`DeepPartial`](/lightweight-charts/docs/next/api/type-aliases/DeepPartial) <[`PriceChartOptions`](/lightweight-charts/docs/next/api/interfaces/PriceChartOptions)>

Optional configuration options for the price chart.

## Returns[​](#returns "Direct link to Returns")

[`IChartApiBase`](/lightweight-charts/docs/next/api/interfaces/IChartApiBase)<`number`>
