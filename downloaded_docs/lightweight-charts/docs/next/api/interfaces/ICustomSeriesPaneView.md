...
• **TSeriesOptions** *extends* [`CustomSeriesOptions`](/lightweight-charts/docs/next/api/type-aliases/CustomSeriesOptions) = [`CustomSeriesOptions`](/lightweight-charts/docs/next/api/type-aliases/CustomSeriesOptions)

## Methods[​](#methods "Direct link to Methods")

### renderer()[​](#renderer "Direct link to renderer()")

> **renderer**(): [`ICustomSeriesPaneRenderer`](/lightweight-charts/docs/next/api/interfaces/ICustomSeriesPaneRenderer)
...
• **data**: [`PaneRendererCustomData`](/lightweight-charts/docs/next/api/interfaces/PaneRendererCustomData)<`HorzScaleItem`, `TData`>
...
> **priceValueBuilder**(`plotRow`): [`CustomSeriesPricePlotValues`](/lightweight-charts/docs/next/api/type-aliases/CustomSeriesPricePlotValues)
...
• **data**: `TData` | [`CustomSeriesWhitespaceData`](/lightweight-charts/docs/next/api/interfaces/CustomSeriesWhitespaceData)<`HorzScaleItem`>
...
• **item1**: [`CustomConflationContext`](/lightweight-charts/docs/next/api/interfaces/CustomConflationContext)<`HorzScaleItem`, `TData`>

• **item2**: [`CustomConflationContext`](/lightweight-charts/docs/next/api/interfaces/CustomConflationContext)<`HorzScaleItem`, `TData`>
