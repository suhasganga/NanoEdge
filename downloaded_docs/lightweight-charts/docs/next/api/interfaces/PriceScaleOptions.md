...
> **mode**: [`PriceScaleMode`](/lightweight-charts/docs/next/api/enumerations/PriceScaleMode)
...
> **scaleMargins**: [`PriceScaleMargins`](/lightweight-charts/docs/next/api/interfaces/PriceScaleMargins)
...
If not provided [LayoutOptions.textColor](/lightweight-charts/docs/next/api/interfaces/LayoutOptions#textcolor) is used.
