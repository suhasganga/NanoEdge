...
### timeWeight[​](#timeweight "Direct link to timeWeight")

> `readonly` **timeWeight**: [`TickMarkWeightValue`](/lightweight-charts/docs/next/api/type-aliases/TickMarkWeightValue)
