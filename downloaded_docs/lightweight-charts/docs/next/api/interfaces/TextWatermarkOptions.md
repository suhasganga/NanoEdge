...
### horzAlign[​](#horzalign "Direct link to horzAlign")

> **horzAlign**: [`HorzAlign`](/lightweight-charts/docs/next/api/type-aliases/HorzAlign)
...
### vertAlign[​](#vertalign "Direct link to vertAlign")

> **vertAlign**: [`VertAlign`](/lightweight-charts/docs/next/api/type-aliases/VertAlign)
...
> **lines**: [`TextWatermarkLineOptions`](/lightweight-charts/docs/next/api/interfaces/TextWatermarkLineOptions)[]
