...
• **options**: [`DeepPartial`](/lightweight-charts/docs/next/api/type-aliases/DeepPartial) <[`TimeChartOptions`](/lightweight-charts/docs/next/api/interfaces/TimeChartOptions)>
...
• **TData** *extends* [`CustomData`](/lightweight-charts/docs/next/api/interfaces/CustomData) <[`Time`](/lightweight-charts/docs/next/api/type-aliases/Time)>
...
• **customPaneView**: [`ICustomSeriesPaneView`](/lightweight-charts/docs/next/api/interfaces/ICustomSeriesPaneView) <[`Time`](/lightweight-charts/docs/next/api/type-aliases/Time), `TData`, `TOptions`>
...
• **handler**: [`MouseEventHandler`](/lightweight-charts/docs/next/api/type-aliases/MouseEventHandler) <[`Time`](/lightweight-charts/docs/next/api/type-aliases/Time)>
...
• **horizontalPosition**: [`Time`](/lightweight-charts/docs/next/api/type-aliases/Time)
