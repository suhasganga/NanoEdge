...
* [`ChartOptionsImpl`](/lightweight-charts/docs/next/api/interfaces/ChartOptionsImpl)<`number`>
...
> **localization**: [`LocalizationOptions`](/lightweight-charts/docs/next/api/interfaces/LocalizationOptions)<`number`>
...
> **yieldCurve**: [`YieldCurveOptions`](/lightweight-charts/docs/next/api/interfaces/YieldCurveOptions)
