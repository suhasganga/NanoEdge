...
> **index**: [`TimePointIndex`](/lightweight-charts/docs/next/api/type-aliases/TimePointIndex)
...
> **weight**: [`TickMarkWeightValue`](/lightweight-charts/docs/next/api/type-aliases/TickMarkWeightValue)
