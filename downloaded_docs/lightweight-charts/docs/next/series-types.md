...
* **Series Definition**: [`AreaSeries`](/lightweight-charts/docs/next/api/variables/AreaSeries)
* **Data format**: [`SingleValueData`](/lightweight-charts/docs/next/api/interfaces/SingleValueData) or [`WhitespaceData`](/lightweight-charts/docs/next/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/next/api/interfaces/SeriesOptionsCommon) and [`AreaStyleOptions`](/lightweight-charts/docs/next/api/interfaces/AreaStyleOptions)

This series is represented with a colored area between the [time scale](/lightweight-charts/docs/next/time-scale) and line connecting all data points:
...
* **Series Definition**: [`BarSeries`](/lightweight-charts/docs/next/api/variables/BarSeries)
* **Data format**: [`BarData`](/lightweight-charts/docs/next/api/interfaces/BarData) or [`WhitespaceData`](/lightweight-charts/docs/next/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/next/api/interfaces/SeriesOptionsCommon) and [`BarStyleOptions`](/lightweight-charts/docs/next/api/interfaces/BarStyleOptions)
...
* **Series Definition**: [`BaselineSeries`](/lightweight-charts/docs/next/api/variables/BaselineSeries)
* **Data format**: [`SingleValueData`](/lightweight-charts/docs/next/api/interfaces/SingleValueData) or [`WhitespaceData`](/lightweight-charts/docs/next/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/next/api/interfaces/SeriesOptionsCommon) and [`BaselineStyleOptions`](/lightweight-charts/docs/next/api/interfaces/BaselineStyleOptions)

This series is represented with two colored areas between the [the base value line](/lightweight-charts/docs/next/api/interfaces/BaselineStyleOptions#basevalue) and line connecting all data points:
...
* **Series Definition**: [`CandlestickSeries`](/lightweight-charts/docs/next/api/variables/CandlestickSeries)
* **Data format**: [`CandlestickData`](/lightweight-charts/docs/next/api/interfaces/CandlestickData) or [`WhitespaceData`](/lightweight-charts/docs/next/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/next/api/interfaces/SeriesOptionsCommon) and [`CandlestickStyleOptions`](/lightweight-charts/docs/next/api/interfaces/CandlestickStyleOptions)
...
* **Series Definition**: [`HistogramSeries`](/lightweight-charts/docs/next/api/variables/HistogramSeries)
* **Data format**: [`HistogramData`](/lightweight-charts/docs/next/api/interfaces/HistogramData) or [`WhitespaceData`](/lightweight-charts/docs/next/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/next/api/interfaces/SeriesOptionsCommon) and [`HistogramStyleOptions`](/lightweight-charts/docs/next/api/interfaces/HistogramStyleOptions)
...
* **Series Definition**: [`LineSeries`](/lightweight-charts/docs/next/api/variables/LineSeries)
* **Data format**: [`LineData`](/lightweight-charts/docs/next/api/interfaces/LineData) or [`WhitespaceData`](/lightweight-charts/docs/next/api/interfaces/WhitespaceData)
* **Style options**: a mix of [`SeriesOptionsCommon`](/lightweight-charts/docs/next/api/interfaces/SeriesOptionsCommon) and [`LineStyleOptions`](/lightweight-charts/docs/next/api/interfaces/LineStyleOptions)
...
To define a custom series type, create a class that implements the [`ICustomSeriesPaneView`](/lightweight-charts/docs/next/api/interfaces/ICustomSeriesPaneView) interface. This class defines the rendering code that Lightweight Charts™ uses to draw the series on the chart.
Once your custom series type is defined, it can be added to any chart instance using the [`addCustomSeries()`](/lightweight-charts/docs/next/api/interfaces/IChartApi#addcustomseries) method. Custom series types function like any other series.

For more information, refer to the [Plugins](/lightweight-charts/docs/next/plugins/intro) article.

## Customization[​](#customization "Direct link to Customization")

Each series type offers a unique set of customization options listed on the [`SeriesStyleOptionsMap`](/lightweight-charts/docs/next/api/interfaces/SeriesStyleOptionsMap) page.
...
* Specify the default options using the corresponding parameter while creating a series:
  ...
  ```
* Use the [`ISeriesApi.applyOptions`](/lightweight-charts/docs/next/api/interfaces/ISeriesApi#applyoptions) method to apply other options on the fly:
