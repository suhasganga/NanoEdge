...
[`ISeriesPrimitive`](/lightweight-charts/docs/next/api/type-aliases/ISeriesPrimitive) interface. The
...
* [`paneViews`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#paneviews)
* [`priceAxisPaneViews`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#priceaxispaneviews)
* [`timeAxisPaneViews`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#timeaxispaneviews)
* [`priceAxisViews`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#priceaxisviews)
* [`timeAxisViews`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#timeaxisviews)
...
### IPrimitivePaneView[​](#iprimitivepaneview "Direct link to IPrimitivePaneView")

The [`IPrimitivePaneView`](/lightweight-charts/docs/next/api/interfaces/IPrimitivePaneView)
...
[`zOrder`](/lightweight-charts/docs/next/api/interfaces/IPrimitivePaneView#zorder) to control where
...
[`draw`](/lightweight-charts/docs/next/api/interfaces/IPrimitivePaneRenderer#draw) method which will
be given a `CanvasRenderingTarget2D` target on which it can draw. Additionally,
a renderer can optionally provide a
[`drawBackground`](/lightweight-charts/docs/next/api/interfaces/IPrimitivePaneRenderer#drawbackground)
method for drawing beneath other elements on the same zOrder.

tip

`CanvasRenderingTarget2D` is explained in more detail on the [Canvas Rendering Target](/lightweight-charts/docs/next/plugins/canvas-rendering-target) page.
...
The [`ISeriesPrimitiveAxisView`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveAxisView)
...
[`coordinate`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveAxisView#coordinate) method,
...
[`attached`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#attached) and
[`detached`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#detached) lifecycle methods to
...
[single argument](/lightweight-charts/docs/next/api/interfaces/SeriesAttachedParameter) containing
...
[`updateAllViews()`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#updateallviews) method
...
The [`autoscaleInfo()`](/lightweight-charts/docs/next/api/interfaces/ISeriesPrimitiveBase#autoscaleinfo)
