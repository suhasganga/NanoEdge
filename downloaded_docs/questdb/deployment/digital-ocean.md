...
## Create a QuestDB Droplet[​](#create-a-questdb-droplet "Direct link to Create a QuestDB Droplet")
...
![Choosing the RAM and CPU capacity for a QuestDB DigitalOcean Droplet](/docs/images/blog/2021-07-09/choosing-droplet.webp)
...
![Finalizing the creation step of a DigitalOcean Droplet running QuestDB](/docs/images/blog/2021-07-09/questdb-droplet.webp)
...
## QuestDB droplet configuration[​](#questdb-droplet-configuration "Direct link to QuestDB droplet configuration")
...
### QuestDB Credentials[​](#questdb-credentials "Direct link to QuestDB Credentials")
...
## API creation[​](#api-creation "Direct link to API creation")
