...
* Data analysts can easily make forecasts on complex data, such as multivariate
  time-series with [high cardinality](https://questdb.com/glossary/high-cardinality/), and
...
### Running the Docker container[​](#running-the-docker-container "Direct link to Running the Docker container")
...
### Adding data to QuestDB[​](#adding-data-to-questdb "Direct link to Adding data to QuestDB")
...
We could populate table house\_rentals\_data with random data:
...
#### CURL command[​](#curl-command "Direct link to CURL command")
...
### Connect to MindsDB[​](#connect-to-mindsdb "Direct link to Connect to MindsDB")
...
### Create a predictor model[​](#create-a-predictor-model "Direct link to Create a predictor model")
...
### Describe the predictor model[​](#describe-the-predictor-model "Direct link to Describe the predictor model")
...
### Query MindsDB for predictions[​](#query-mindsdb-for-predictions "Direct link to Query MindsDB for predictions")
...
### Stop the container[​](#stop-the-container "Direct link to Stop the container")
