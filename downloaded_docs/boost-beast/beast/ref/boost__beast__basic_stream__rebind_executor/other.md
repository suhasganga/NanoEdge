##### [basic\_stream::rebind\_executor::other](other.html "basic_stream::rebind_executor::other")

The stream type when rebound to the specified executor.

###### [Synopsis](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.synopsis)

```programlisting
using other = basic_stream< Protocol, Executor1, RatePolicy >;
```

###### [Types](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.types)
...
| **[rebind\_executor](../boost__beast__basic_stream__rebind_executor.html "basic_stream::rebind_executor") [constructor]** | Rebinds the stream type to another executor. |
| **[socket\_type](../boost__beast__basic_stream/socket_type.html "basic_stream::socket_type")** | The type of the underlying socket. |

###### [Member Functions](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.member_functions)
...
* An *Executor* may be associated with the stream,
  which will be used to invoke any completion handlers which do not already
  have an associated executor. This achieves support for [[P1322R0]
...
from use of `net::bind_executor`) will be invoked by the
stream using the associated executor. Otherwise, the completion handler
will be invoked by the executor associated with the stream upon construction.
The type of executor used with this stream must meet the following requirements:
...
Unlike other stream wrappers, the underlying socket is accessed through
the [`socket`](../boost__beast__basic_stream/socket.html "basic_stream::socket") member function instead
of `next_layer`. This causes
the [`basic_stream`](../boost__beast__basic_stream.html "basic_stream") to be returned in
calls to [`get_lowest_layer`](../boost__beast__get_lowest_layer.html "get_lowest_layer").

###### [Usage](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.usage)

To use this stream declare an instance of the class. Then, before each
logical operation for which a timeout is desired, call [`expires_after`](../boost__beast__basic_stream/expires_after.html "basic_stream::expires_after") with a duration,
or call [`expires_at`](../boost__beast__basic_stream/expires_at.html "basic_stream::expires_at") with a time point.
Alternatively, call [`expires_never`](../boost__beast__basic_stream/expires_never.html "basic_stream::expires_never") to disable the timeout
...
be invoked with the error [`beast::error::timeout`](../boost__beast__error.html "error").

###### [Examples](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.examples)

This function reads an HTTP request with a timeout, then sends the HTTP
response with a different timeout.
...
###### [Blocking I/O](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.blocking_i_o)

Synchronous functions behave identically as that of the wrapped `net::basic_stream_socket`. Timeouts are not
available when performing blocking calls.

###### [Template Parameters](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.template_parameters)
...
###### [Thread Safety](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.thread_safety)

*Distinct objects*: Safe.

*Shared objects*: Unsafe. The application must also
ensure that all asynchronous operations are performed within the same implicit
or explicit strand.

###### [See Also](other.html#beast.ref.boost__beast__basic_stream__rebind_executor.other.see_also)
