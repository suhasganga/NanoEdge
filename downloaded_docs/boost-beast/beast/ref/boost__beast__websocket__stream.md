#### [websocket::stream](boost__beast__websocket__stream.html "websocket::stream")

Provides message-oriented functionality using WebSocket.

##### [Synopsis](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.synopsis)
...
##### [Types](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.types)
...
| **[rebind\_executor](boost__beast__websocket__stream__rebind_executor.html "websocket::stream::rebind_executor")** | Rebinds the stream type to another executor. |

##### [Member Functions](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.member_functions)
...
| **[stream](boost__beast__websocket__stream/stream.html "websocket::stream::stream") [constructor]** | Constructor.  — Rebinding constructor. |
...
##### [Description](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.description)

The [`stream`](boost__beast__websocket__stream.html "websocket::stream") class template provides asynchronous
...
##### [Thread Safety](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.thread_safety)
...
##### [Example](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.example)

To declare the [`stream`](boost__beast__websocket__stream.html "websocket::stream") object with a [`tcp_stream`](boost__beast__tcp_stream.html "tcp_stream") in a multi-threaded asynchronous
...
##### [Template Parameters](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.template_parameters)
...
##### [Remarks](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.remarks)

A stream object must not be moved or destroyed while there are pending asynchronous
operations associated with it.

##### [See Also](boost__beast__websocket__stream.html#beast.ref.boost__beast__websocket__stream.see_also)
