#### [http::param\_list](boost__beast__http__param_list.html "http::param_list")

A list of parameters in an HTTP extension field value.

##### [Synopsis](boost__beast__http__param_list.html#beast.ref.boost__beast__http__param_list.synopsis)
...
##### [Types](boost__beast__http__param_list.html#beast.ref.boost__beast__http__param_list.types)
...
##### [Member Functions](boost__beast__http__param_list.html#beast.ref.boost__beast__http__param_list.member_functions)
...
| **[param\_list](boost__beast__http__param_list/param_list.html "http::param_list::param_list") [constructor]** | Default constructor.  — Construct a list. |

##### [Description](boost__beast__http__param_list.html#beast.ref.boost__beast__http__param_list.description)
...
##### [BNF](boost__beast__http__param_list.html#beast.ref.boost__beast__http__param_list.bnf)
...
To use this class, construct with the string to be parsed and then use [`begin`](boost__beast__http__param_list/begin.html "http::param_list::begin")
and [`end`](boost__beast__http__param_list/end.html "http::param_list::end"), or range-for to iterate each
item:

##### [Example](boost__beast__http__param_list.html#beast.ref.boost__beast__http__param_list.example)
