##### [buffered\_read\_stream::async\_write\_some](async_write_some.html "buffered_read_stream::async_write_some")

Start an asynchronous write.

###### [Synopsis](async_write_some.html#beast.ref.boost__beast__buffered_read_stream.async_write_some.synopsis)
...
###### [Description](async_write_some.html#beast.ref.boost__beast__buffered_read_stream.async_write_some.description)

This function is used to asynchronously write data from the stream. The
function call always returns immediately.

###### [Parameters](async_write_some.html#beast.ref.boost__beast__buffered_read_stream.async_write_some.parameters)

| Name | Description |
| --- | --- |
| `buffers` | One or more data buffers to be written to the stream. Although the buffers object may be copied as necessary, ownership of the underlying memory blocks is retained by the caller, which must guarantee that they remain valid until the handler is called. |
