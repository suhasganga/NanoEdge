##### [http::parser::need\_eof](need_eof.html "http::parser::need_eof")
...
###### [Synopsis](need_eof.html#beast.ref.boost__beast__http__parser.need_eof.synopsis)
...
###### [Description](need_eof.html#beast.ref.boost__beast__http__parser.need_eof.description)
...
to call [`put_eof`](put_eof.html "http::parser::put_eof") when there will never
