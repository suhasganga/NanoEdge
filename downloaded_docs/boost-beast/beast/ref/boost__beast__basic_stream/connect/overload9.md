###### [basic\_stream::connect (9 of 10 overloads)](overload9.html "basic_stream::connect (9 of 10 overloads)")

Establishes a connection by trying each endpoint in a sequence.

###### [Synopsis](overload9.html#beast.ref.boost__beast__basic_stream.connect.overload9.synopsis)
...
###### [Description](overload9.html#beast.ref.boost__beast__basic_stream.connect.overload9.description)
...
###### [Parameters](overload9.html#beast.ref.boost__beast__basic_stream.connect.overload9.parameters)
...
###### [Return Value](overload9.html#beast.ref.boost__beast__basic_stream.connect.overload9.return_value)

An iterator denoting the successfully connected endpoint.

###### [Exceptions](overload9.html#beast.ref.boost__beast__basic_stream.connect.overload9.exceptions)

| Type | Thrown On |
| --- | --- |
| `boost::system::system_error` | Thrown on failure. If the sequence is empty, the associated [`error_code`](../../boost__beast__error_code.html "error_code") is `net::error::not_found`. Otherwise, contains the error from the last connection attempt. |