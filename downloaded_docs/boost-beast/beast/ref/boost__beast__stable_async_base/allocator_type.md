##### [stable\_async\_base::allocator\_type](allocator_type.html "stable_async_base::allocator_type")

(Inherited from [`async_base`](../boost__beast__async_base.html "async_base"))

The type of allocator associated with this object.

###### [Synopsis](allocator_type.html#beast.ref.boost__beast__stable_async_base.allocator_type.synopsis)

```programlisting
using allocator_type = net::associated_allocator_t< Handler, Allocator >;
```

###### [Description](allocator_type.html#beast.ref.boost__beast__stable_async_base.allocator_type.description)
