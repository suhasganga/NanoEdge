##### [stable\_async\_base::cancellation\_slot\_type](cancellation_slot_type.html "stable_async_base::cancellation_slot_type")
...
###### [Synopsis](cancellation_slot_type.html#beast.ref.boost__beast__stable_async_base.cancellation_slot_type.synopsis)

```programlisting
using cancellation_slot_type = beast::detail::filtering_cancellation_slot< net::associated_cancellation_slot_t< Handler > >;
```

###### [Description](cancellation_slot_type.html#beast.ref.boost__beast__stable_async_base.cancellation_slot_type.description)
