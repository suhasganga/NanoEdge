##### [test::basic\_stream::rebind\_executor::other](other.html "test::basic_stream::rebind_executor::other")

The socket type when rebound to the specified executor.

###### [Synopsis](other.html#beast.ref.boost__beast__test__basic_stream__rebind_executor.other.synopsis)

```programlisting
using other = basic_stream< Executor1 >;
```

###### [Types](other.html#beast.ref.boost__beast__test__basic_stream__rebind_executor.other.types)
...
| **[rebind\_executor](../boost__beast__test__basic_stream__rebind_executor.html "test::basic_stream::rebind_executor") [constructor]** | Rebinds the socket type to another executor. |

###### [Member Functions](other.html#beast.ref.boost__beast__test__basic_stream__rebind_executor.other.member_functions)
...
made available, or until the endpoints become disconnected.
...
a test stream in a call to `net::read_until`,
...
* The input area, represented by a [`beast::basic_flat_buffer`](../boost__beast__basic_flat_buffer.html "basic_flat_buffer"), may be
...
###### [Thread Safety](other.html#beast.ref.boost__beast__test__basic_stream__rebind_executor.other.thread_safety)
