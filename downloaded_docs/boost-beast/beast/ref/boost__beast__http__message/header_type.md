##### [http::message::header\_type](header_type.html "http::message::header_type")

The base class used to hold the header portion of the message.

###### [Synopsis](header_type.html#beast.ref.boost__beast__http__message.header_type.synopsis)

```programlisting
using header_type = header< isRequest, Fields >;
```

###### [Types](header_type.html#beast.ref.boost__beast__http__message.header_type.types)
...
###### [Member Functions](header_type.html#beast.ref.boost__beast__http__message.header_type.member_functions)
...
###### [Protected Member Functions](header_type.html#beast.ref.boost__beast__http__message.header_type.protected_member_functions)
...
###### [Static Members](header_type.html#beast.ref.boost__beast__http__message.header_type.static_members)
