##### [http::vector\_body::size](size.html "http::vector_body::size")

Returns the payload size of the body.

###### [Synopsis](size.html#beast.ref.boost__beast__http__vector_body.size.synopsis)
...
###### [Description](size.html#beast.ref.boost__beast__http__vector_body.size.description)
