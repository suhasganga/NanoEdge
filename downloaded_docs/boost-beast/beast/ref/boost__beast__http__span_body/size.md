##### [http::span\_body::size](size.html "http::span_body::size")

Returns the payload size of the body.

###### [Synopsis](size.html#beast.ref.boost__beast__http__span_body.size.synopsis)
...
###### [Description](size.html#beast.ref.boost__beast__http__span_body.size.description)
