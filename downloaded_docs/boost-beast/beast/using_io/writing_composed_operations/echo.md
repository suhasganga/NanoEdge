...
async_echo (
    AsyncStream& stream,
    DynamicBuffer& buffer, ![1](../../../../../../../doc/src/images/callouts/1.png)
    CompletionToken&& token) ->
        typename net::async_result< ![2](../../../../../../../doc/src/images/callouts/2.png)
            typename std::decay<CompletionToken>::type,
            void(beast::error_code) ![3](../../../../../../../doc/src/images/callouts/3.png)
                >::return_type;
```

|  |  |
| --- | --- |
| [1](#beast.using_io.writing_composed_operations.echo.c0) | Unlike Asio, we pass by non-const reference instead of rvalue-ref |
| [2](#beast.using_io.writing_composed_operations.echo.c2) | `async_result` deduces the return type from the completion handler |
| [3](#beast.using_io.writing_composed_operations.echo.c4) | The completion handler signature goes here |
...
the input parameters, set up the return value as per [**N3747**](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3747.pdf), and launch the composed operation
...
Rather than using `std::bind` or `boost::bind`,
which destroys the type information and therefore breaks the associators,
we will simply pass `std::move(*this)`
...
async_echo(
    ...
    CompletionToken&& token) ->
        typename net::async_result<
            typename std::decay<CompletionToken>::type,
            void(beast::error_code)>::return_type ![1](../../../../../../../doc/src/images/callouts/1.png)
{
    ...
    using base_type = beast::async_base<
        handler_type, ![2](../../../../../../../doc/src/images/callouts/2.png)
        beast::executor_type<AsyncStream> ![3](../../../../../../../doc/src/images/callouts/3.png)
    >;
    ...
    struct echo_op : base_type, boost::asio::coroutine
    {
        ...
        echo_op(
            ...
            : base_type(
                std::move(handler), ![4](../../../../../../../doc/src/images/callouts/4.png)
                stream.get_executor()) ![5](../../../../../../../doc/src/images/callouts/5.png)
            , stream_(stream)
            , buffer_(buffer)
        {
...
|  |  |
| --- | --- |
| [1](#beast.using_io.writing_composed_operations.echo.c6) | The completion handler signature goes here |
| [2](#beast.using_io.writing_composed_operations.echo.c8) | The type of the completion handler obtained from the token |
| [3](#beast.using_io.writing_composed_operations.echo.c10) | The type of executor used by the stream to dispatch asynchronous operations |
| [4](#beast.using_io.writing_composed_operations.echo.c12) | The `async_base` helper takes ownership of the handler, |
| [5](#beast.using_io.writing_composed_operations.echo.c14) | and also needs to know which executor to use. |
...
* Calling a synchronous function by accident. In general composed operations
  ...
  running on the [`net::io_context`](../../../../../../../doc/html/boost_asio/reference/io_context.html).
* Forgetting to provide `executor_type`
  ...
  object, and there is more than thread running on the [`net::io_context`](../../../../../../../doc/html/boost_asio/reference/io_context.html), the underlying
  ...
  you.
* Forgetting to create an object of type [`net::executor_work_guard`](../../../../../../../doc/html/boost_asio/reference/executor_work_guard.html) with
  the type of executor returned by the stream's `get_executor`
  member function.
* For operations which complete immediately (i.e. without calling an
  intermediate initiating function), forgetting to use [`net::post`](../../../../../../../doc/html/boost_asio/reference/post.html) to invoke the final
  ...
  *Regardless of whether the asynchronous operation completes
  ...
  to using [`net::post`](../../../../../../../doc/html/boost_asio/reference/post.html)*. The function
  [`bind_handler`](../../ref/boost__beast__bind_handler.html "bind_handler") is provided for
  this purpose.

The listing for a complete, runnable version of this example is in [echo\_op.cpp](../../../../../example/echo-op/echo_op.cpp).