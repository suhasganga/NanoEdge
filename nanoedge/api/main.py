...
from nanoedge.api.dependencies import lifespan
from nanoedge.api.history import router as history_router
from nanoedge.api.metrics import router as metrics_router
from nanoedge.api.symbols import router as symbols_router
from nanoedge.api.websocket import router as ws_router
...
app = FastAPI(
    title="NanoEdge",
    description="NanoEdge - High-Frequency Trading Platform",
    version="0.1.0",
    lifespan=lifespan,
)
