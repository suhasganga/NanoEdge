...
from nanoedge.config import Settings, settings
...
from nanoedge.core.clock_sync import ClockSync, clock_sync_registry
from nanoedge.core.logging import configure_logging
from nanoedge.core.ring_buffer import TickRingBuffer
from nanoedge.core.types import OHLCV, MarketStats, MarketTick, OrderBookSnapshot, Trade
...
if TYPE_CHECKING:
    ...
    from nanoedge.subscriptions.manager import SubscriptionManager
    from nanoedge.symbols.service import SymbolMasterService
...
def handle_trade(trade: Trade) -> None:
    ...
    try:
        from nanoedge.mm.routes import process_trade_for_simulation
...
async def lifespan(app):
    ...
    try:
        from nanoedge.symbols.service import SymbolMasterService, set_symbol_service
