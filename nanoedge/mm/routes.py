...
from nanoedge.mm.types import OrderSide, GridOrderConfig
from nanoedge.mm.simulator import OrderSimulator
from nanoedge.mm.ws_types import (
    encode_order_update,
...
def process_trade_for_simulation(trade) -> None:
    ...
    This should be called from nanoedge/api/dependencies.py handle_trade().
    """
